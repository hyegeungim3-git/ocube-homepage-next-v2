...
export const featLists: Record<string, readonly FeatItem[]> = {
  ...
  "solution-dataq:overview": [
    {
      label: ["Collection and integration"],
      body: [
        "PLC, sensors, MES and ERP connected, with differing protocols and formats turned into one common input",
      ],
    },
    {
      label: ["Format and meaning standardised"],
      body: ["Names, units and relationships that differ by machine, brought to one standard"],
    },
    {
      label: ["Building AI-ready data"],
      body: ["Shaped for document retrieval (RAG, CAG), data querying (TAG) and predictive models"],
    },
    {
      label: ["Analysis and services"],
      body: ["Dashboards and live queries, ready for QFactory and AgentQ to use"],
    },
  ],
  "solution-dataq:standards": [
    {
      label: ["Interoperability standards"],
      body: ["OPC-UA and ISA-95 as reference, unifying mixed equipment data into a standard layer"],
    },
    {
      label: ["Data governance"],
      body: ["Catalogue, lineage and quality rules keep origin and trustworthiness traceable"],
    },
    {
  ...
  "solution-qdrive:overview": [
    {
      label: ["Collecting vehicle data"],
      body: [
        "Tachograph records and diagnostic signals gathered, and vehicle and trip state put into one common format",
      ],
    },
    {
      label: ["Driving and safety analysis"],
      body: [
        "Speed, harsh acceleration and hard braking are read to find risky driving and where it can improve",
      ],
    },
    {
      label: ["Energy and charging"],
      body: ["Battery and energy use are watched, and charging and discharging schedules tuned"],
    },
    {
      label: ["Carbon management"],
      body: ["Distance and energy data give the emissions figure — and the reduction achieved"],
    },
  ],
  "solution-traffic:overview": [
    {
      label: ["Recognising what is there"],
      body: [
    ...
    {
      label: ["Traffic flow"],
      body: ["Counts by vehicle type, congestion and changes in speed, hour by hour"],
    },
    {
      label: ["Spotting danger"],
      body: [
  ...
  "solution-traffic:detect": [
    {
      label: ["Designed against false alarms"],
      body: ["Confidence score, consecutive frames and human review before it is confirmed"],
    },
    {
      label: ["Night and bad weather"],
      body: ["Detection in low light, backlight and rain, corrected with real operating data"],
    },
    {
      label: ["Protecting personal image data"],
      body: ["Blurring, separated access rights and retention limits keep it within the rules"],
    },
  ],
};
