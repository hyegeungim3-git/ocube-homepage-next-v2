  ...
  "business-embedded:projects": [
    {
      ...
      "cat": "SDV / OTA UPDATE",
      "title": [
        "Hyundai wired and wireless updates"
      ],
      "sum": [
        "Edge device OTA solution"
      ],
      "bullets": [
        [
          "DCU · CCU"
    ...
    },
    {
      ...
      "cat": "AUTOMOTIVE",
      "title": [
        "AUTOSAR development with Mobilgene"
      ],
      "sum": [
  ...
  "business-si:projects": [
    {
      ...
      "title": [
        "Integrated financial SI · Group communication app"
      ],
      "sum": [
    ...
    },
    {
      ...
      "title": [
        "ThinQ home AIoT · webOS · enterprise cloud"
      ],
      "sum": [
        "Home AIoT connected services, webOS apps and enterprise cloud — designed and built"
      ],
      "bullets": [
        [
          "ThinQ app"
    ...
    },
    {
      ...
      "sum": [
        "Charger integration, monitoring and billing — from planning through to delivery"
      ],
      "bullets": [
        [
          "Charger integration"
...
export const homeCases: readonly HomeCase[] = [
  {
    ...
    "title": [
      "Factory Insight AI — spotting assembly line faults early"
    ],
    "sum": [
      "A manufacturing AI system that catches equipment anomalies the moment they appear"
    ],
    "bullets": [
      [
  ...
  },
  {
    ...
    "title": [
      "Vehicle HMI and middleware for a global OEM"
    ],
    "sum": [
  ...
  },
  {
    ...
    "sum": [
      "A global platform that joins many devices and services into one experience"
    ],
    "bullets": [
      [
