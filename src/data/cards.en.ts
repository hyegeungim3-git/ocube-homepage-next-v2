...
export const depCards: Record<string, readonly DepCardItem[]> = {
  "license-protopie:industry": [
    {
      ...
      "body": [
        "Screen flow and user experience tried out before an app or web service is built"
      ]
    },
    {
      "title": [
        "Automotive (in-vehicle HMI)"
      ],
      "body": [
    ...
    {
      "title": [
        "Smart devices (IoT and wearables)"
      ],
      "body": [
        "Designing and testing UX and UI for smart TVs, watches and connected home devices"
      ]
    },
    {
      "title": [
  ...
  "license-telit:usecase": [
    {
      ...
      "body": [
        "Industrial gateways that carry equipment and sensor data over the cellular network"
      ]
    },
    {
      "title": [
      ...
      "body": [
        "Tracking and monitoring units combining GPS and GLONASS"
      ]
    },
    {
      "title": [
  ...
  "license-toradex:why": [
    ...
    },
    {
      ...
      "body": [
        "Choosing a compatible model in the same family means less carrier board to redesign"
      ]
    },
    {
      "title": [
    ...
    },
    {
      ...
      "body": [
        "Boot optimisation, GPU, cryptographic acceleration and 3D rendering, all put to use"
      ]
    },
    {
      "title": [
      ...
      "body": [
        "Board support package, GPIO, display configuration and system monitoring tools"
      ]
    },
    {
      "title": [
  ...
  "license-tuxera:apply": [
    ...
    },
    {
      ...
      "body": [
        "Flash life managed and storage kept fail-safe in harsh conditions"
      ]
    },
    {
      "title": [
      ...
      "body": [
        "Aerospace, medical and anywhere else consistency and recovery are not optional"
      ]
    }
  ],
  "license-visualon:apply": [
    ...
    {
      "title": [
        "Broadcast and devices"
      ],
      "body": [
        "Media playback software for embedded devices such as smart TVs and set-top boxes"
      ]
    }
  ],
  "solution-agentq:pipeline": [
    {
      ...
      "body": [
        ...
        {
          "b": [
            "the source and its classification"
          ]
        },
        "alongside it"
      ]
    },
    {
      ...
      "body": [
        ...
        {
          "b": [
            "tables, charts and the conditions used"
          ]
        },
        ""
      ]
  ...
  "solution-agentq:scenarios": [
    ...
    },
    {
      ...
      "body": [
        ...
        {
          "b": [
            "statistics, outlier checks and charts"
          ]
        },
        "on top"
      ]
    },
    {
      ...
      "body": [
        ...
        {
          "b": [
            "one workflow across several agents"
          ]
        },
        ""
      ]
    },
    {
      ...
      "body": [
        ...
        {
          "b": [
            "approval by the person responsible"
          ]
        },
        ""
      ]
  ...
  "solution-evcp:fit": [
    {
      "title": [
        "New to the charging business"
      ],
      "body": [
        "Where membership, payment and monitoring all have to be built from nothing"
      ]
    },
    {
      "title": [
        "Running chargers from several makers"
      ],
      "body": [
    ...
    {
      "title": [
        "Growing the business in stages"
      ],
      "body": [
        "Adding what is needed now, and leaving roaming for later"
      ]
    },
    {
      "title": [
      ...
      "body": [
        "Where you want to decide the screens and the pricing yourself"
      ]
    }
  ],
  ...
  "solution-traffic:fit": [
    ...
    },
    {
      ...
      "body": [
        ...
        {
          "b": [
            "personal data is masked where it is filmed"
          ]
        },
        ""
      ]
