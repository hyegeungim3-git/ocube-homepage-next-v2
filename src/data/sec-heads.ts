...
export const secHeads: Record<string, SecHeadCopy> = {
  ...
  "business-embedded:applications": {
    ...
    kicker: "Applications",
    title: ["적용 분야"],
    sub: ["자동차부터 산업 장비와 IoT 엣지까지, 제품 환경에 맞는 임베디드 소프트웨어를 제공합니다."],
    subCls: "sec-sub",
  },
  "business-si:applications": {
    ...
    kicker: "Applications",
    title: ["적용 분야"],
    sub: ["금융부터 기업·", "wbr", "공공·", "wbr", "에너지·", "wbr", "스마트홈·", "wbr", "모빌리티까지, 업무와 서비스를 안정적인 시스템으로 구현합니다."],
    subCls: "sec-sub",
  },
  ...
  "license-qt:partner": {
    ...
    sub: ["오큐브는 2010년 국내 최초로 Nokia Qt Certified Partner 자격을 취득한 The Qt Company 공식 파트너입니다."],
    subCls: "sec-sub",
  },
  ...
  "license-toradex:why": {
    ...
    kicker: "Why Toradex",
    title: ["왜 Toradex인가"],
    sub: ["Toradex는 성능·엔지니어링 지원·장기 공급·제품 유지관리를 함께 고려해 개발부터 양산 이후까지 필요한 제품군과 지원 체계를 제공합니다."],
    subCls: "sec-sub",
  },
  ...
  "solution-agentq:overview": {
    ...
    sub: ["업무 포털에 요청하면 필요한 전문 에이전트가 문서·지식·데이터를 이어서 처리해 반복 가능한 AI 업무 흐름을 만듭니다."],
    subCls: "sec-sub",
  },
  "solution-agentq:proof": {
    ...
    sub: ["프로토타입은 서로 다른 전문 기능을 순서대로 연결해 사람이 검토할 수 있는 업무 결과물을 만드는 흐름을 보여줍니다."],
    subCls: "sec-sub",
  },
  "solution-agentq:scenarios": {
    ...
    sub: ["문서·데이터·규정이 함께 얽혀 있고, 결과물의 근거와 운영 통제가 필요한 업무에 적합합니다."],
    subCls: "sec-sub",
  },
  "solution-cubeon:overview": {
    ...
    titleWhite: true,
    sub: ["Cubeon은 데이터 연결부터 AI 모델·", "wbr", "에이전트 운영, 담당자 승인과 실행 결과 확인까지 하나의 플랫폼에서 관리합니다."],
    subCls: "sec-sub",
  },
  "solution-cubeon:fit": {
    cls: "reveal",
    kicker: "Ideal Use Cases",
    title: ["이런 조직에 적합합니다"],
    sub: ["분산된 데이터와 AI 서비스를 하나의 운영 기준으로 연결하고 실행까지 관리하려는 조직에 적합합니다."],
    subCls: "sec-sub",
  },
  "solution-dataq:overview": {
    ...
    sub: ["QData는 여러 시스템과 조직에 흩어진 데이터를 연결해 분석과 AI에 활용할 수 있는 형태로 정리합니다."],
    subCls: "sec-sub",
  },
  "solution-dataq:fit": {
    cls: "reveal",
  ...
  "solution-evcp:overview": {
    ...
    sub: ["EVCP는 충전기 연결부터 회원·", "wbr", "결제·", "wbr", "관제까지 통합하고 AI 분석으로 장애 대응과 에너지 운영을 지원합니다."],
    subCls: "sec-sub",
  },
  "solution-evcp:fit": {
    cls: "reveal",
  ...
  "solution-factoryq:overview": {
    ...
    sub: ["QFactory는 기존 설비를 유지한 채 필요한 공정의 데이터를 모아 예측 결과를 공정 조치로 연결합니다."],
    subCls: "sec-sub",
  },
  ...
  "solution-traffic:overview": {
    ...
    sub: ["CCTV 영상으로 차종별 통행량을 분석하고, 실시간으로 포트홀과 돌발상황을 감지해 관제 시스템에 전달합니다."],
    subCls: "sec-sub",
  },
