...
const subnavItemsKo: Record<string, readonly { href: string; label: readonly RichToken[] }[]> = {
  "solution-agentq": [
...
// 두 언어. 화면에서는 subnavItems[lang] 처럼 언어로 먼저 고른다.
// 영어는 i18n/*.json 사전에서 그리는 시점에 만들어진다 (src/i18n/localize.ts).
export const subnavItems = localized(subnavItemsKo);
