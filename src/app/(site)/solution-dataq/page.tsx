...
export default function SolutionDataqPage() {
  return (
    <>
      <title>
        QData 산업 데이터 플랫폼 — 오큐브
      </title>
      <meta name="description" content="QData — 이기종 산업·OT 데이터를 수집·표준화·통합해 산업 AI가 신뢰할 데이터를 만드는 플랫폼." />
      <link rel="canonical" href={withBase("solution-dataq.html")} />
      ...
      <meta property="og:title" content="QData 산업 데이터 플랫폼 — 오큐브" />
      <meta property="og:description" content="QData — 이기종 산업·OT 데이터를 수집·표준화·통합해 산업 AI가 신뢰할 데이터를 만드는 플랫폼." />
      <meta property="og:url" content={withBase("solution-dataq.html")} />
      <meta property="og:image" content={withBase("og-codex.png")} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="QData 산업 데이터 플랫폼 — 오큐브" />
      <meta name="twitter:description" content="QData — 이기종 산업·OT 데이터를 수집·표준화·통합해 산업 AI가 신뢰할 데이터를 만드는 플랫폼." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"QData\",\"item\":\"@@BASE@@solution-dataq.html\"}]}") }} />
      <SiteHeader slug="solution-dataq" />
      <MobilePanel />
      <main>
              ...
              <div className="wrap">
                <div className="ktsum reveal" data-d="4">
                  ...
                  <div className="ktsum-card">
                    ...
                    {" "}
                    <p>
                      표와 도면이 섞인 업무 문서를 의미 단위로 정리하고, 문자 인식(OCR)과 음성 인식(STT)으로{" "}
                      <b>
                        검색·
                        <wbr />
                        학습 가능한 데이터로 바꿉니다.
                  ...
                  <div className="ktsum-card">
                    ...
                    <p>
                      ...
                      로 서로 다른 이름과 단위를 통일하고, 데이터 관계와 의미 기반 검색을 함께 지원합니다.
                    </p>
                  </div>
                  <div className="ktsum-card">
                    {" "}
