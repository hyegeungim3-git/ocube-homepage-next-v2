...
export default function LicenseTelitPage() {
  return (
    <>
      <title>
        Telit Cinterion — 셀룰러 IoT 모듈 | Global Partners · 오큐브(주)
      </title>
      <meta name="description" content="M2M·IoT 애플리케이션을 위한 Telit Cinterion 모듈 — 오큐브가 공급과 국내 엔지니어링 지원을 제공합니다." />
      ...
      <meta property="og:title" content="Telit Cinterion — 셀룰러 IoT 모듈 | Global Partners · 오큐브(주)" />
      <meta property="og:description" content="M2M·IoT 애플리케이션을 위한 Telit Cinterion 모듈 — 오큐브가 공급과 국내 엔지니어링 지원을 제공합니다." />
      <meta property="og:url" content={withBase("license-telit.html")} />
      <meta property="og:image" content={withBase("og-codex.png")} />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="Telit Cinterion — 셀룰러 IoT 모듈 | Global Partners · 오큐브(주)" />
      <meta name="twitter:description" content="M2M·IoT 애플리케이션을 위한 Telit Cinterion 모듈 — 오큐브가 공급과 국내 엔지니어링 지원을 제공합니다." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Telit Cinterion\",\"item\":\"@@BASE@@license-telit.html\"}]}") }} />
                ...
                <div className="feat-list" style={{marginTop: "18px"}}>
                  <div className="feat">
                    ...
                    <p>
                      Java™, GPS·
                      <wbr />
                      GLONASS, SL Agent, SIM Access Profile 등 제품에 필요한 기능을 모듈에 통합했습니다.
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
        ...
        <section id="usecase" className="sec-anchor deploy">
          <div className="wrap">
            ...
            <p className="sec-note reveal" data-d="2">
              오큐브는 통신 모듈 공급 경험을 바탕으로 제품 선정, 안테나 설계와 적용 국가의 통신사 인증 준비를 함께 지원합니다.
            </p>
          </div>
        </section>
      </main>
