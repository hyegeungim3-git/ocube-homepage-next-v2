...
export default function LicenseToradexPage() {
  return (
    <>
      <title>Toradex — 산업용 SoM · 캐리어보드 | Global Partners · 오큐브(주)</title>
      <meta
        name="description"
        content="2003년 스위스 설립 Toradex의 System on Module — 오큐브가 공급과 국내 엔지니어링 지원을 제공합니다."
      />
      ...
      <meta
        property="og:title"
        content="Toradex — 산업용 SoM · 캐리어보드 | Global Partners · 오큐브(주)"
      />
      <meta
