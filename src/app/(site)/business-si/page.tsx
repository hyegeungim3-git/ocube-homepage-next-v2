...
export default function BusinessSiPage() {
  return (
    <>
      ...
      <meta name="description" content="오큐브 SI — 복잡한 B2B·B2G 업무를 분석하고 설계·개발·통합 검증·이행·운영까지 안정적인 시스템으로 구현합니다." />
      ...
      <meta property="og:description" content="오큐브 SI — 복잡한 B2B·B2G 업무를 분석하고 설계·개발·통합 검증·이행·운영까지 안정적인 시스템으로 구현합니다." />
      ...
      <meta name="twitter:description" content="오큐브 SI — 복잡한 B2B·B2G 업무를 분석하고 설계·개발·통합 검증·이행·운영까지 안정적인 시스템으로 구현합니다." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"SI\",\"item\":\"@@BASE@@business-si.html\"}]}") }} />
        ...
        <section className="hero page-hero business-hero dark">
          ...
          <div className="wrap business-hero-copy">
            ...
            <h1 className="business-hero-ko">
              {" "}
              <span>
                고객의 요구를 안정적인 시스템으로 구현하고 연결하여,
              </span>
              {" "}
              <span>
                더 효율적인 비즈니스 환경을 만듭니다.
              </span>
              {" "}
            </h1>
          </div>
