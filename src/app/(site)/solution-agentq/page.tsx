...
export default function SolutionAgentqPage() {
  return (
    <>
      <title>
        AgentQ 멀티 AI 에이전트 플랫폼 — 오큐브
      </title>
      <meta name="description" content="AgentQ — 문서·음성·데이터베이스를 다루는 전문 AI 에이전트가 업무를 나눠 맡고, 중간 결과를 이어받아 검토 가능한 문서와 실행안까지 완성하는 기업용 멀티 에이전트 플랫폼." />
      <link rel="canonical" href={withBase("solution-agentq.html")} />
      ...
      <meta property="og:title" content="AgentQ 멀티 AI 에이전트 플랫폼 — 오큐브" />
      <meta property="og:description" content="AgentQ — 문서·음성·데이터베이스를 다루는 전문 AI 에이전트가 업무를 나눠 맡고, 중간 결과를 이어받아 검토 가능한 문서와 실행안까지 완성하는 기업용 멀티 에이전트 플랫폼." />
      <meta property="og:url" content={withBase("solution-agentq.html")} />
      <meta property="og:image" content={withBase("og-codex.png")} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="AgentQ 멀티 AI 에이전트 플랫폼 — 오큐브" />
      <meta name="twitter:description" content="AgentQ — 문서·음성·데이터베이스를 다루는 전문 AI 에이전트가 업무를 나눠 맡고, 중간 결과를 이어받아 검토 가능한 문서와 실행안까지 완성하는 기업용 멀티 에이전트 플랫폼." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"AgentQ\",\"item\":\"@@BASE@@solution-agentq.html\"}]}") }} />
      <SiteHeader slug="solution-agentq" />
      <MobilePanel />
      <main>
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              {" "}
              <h2>
                업무마다 알맞은 전문 에이전트를 바로 연결합니다
              </h2>
              <p className="lead">
                지식 검색·문서 작성·음성 기록·규정 검토·데이터 조회·보안 채팅을 하나의 플랫폼에서 제공합니다.
              </p>
            </div>
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <p>
                  사내 문서와 업무 규정을 자연어로 검색하고, 답변에 사용한 근거와 출처를 함께 확인합니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>
                    ...
                    {" "}표현이 달라도 의미가 가까운 문서와 조항을 탐색
                  </li>
                  <li>
                    <b>
                      근거·출처 확인
                    </b>
                    {" "}답변과 함께 원문 위치와 관련 문서를 제시
                  </li>
                  <li>
                    <b>
                      검색 범위 적용
                    </b>
                    {" "}업무 영역과 문서 보안 등급에 맞는 자료만 조회
                  </li>
                </ul>
              </div>
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <p>
                  핵심 내용만 입력하면 조직에서 사용하는 양식에 맞춰 보고서 초안을 만들고 검토할 수 있게 정리합니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>
                    ...
                    {" "}주간 실적·업무 조사·시황 등 업무별 표준 서식 제공
                  </li>
                  <li>
                    <b>
                      정보 자동 구성
                    </b>
                    {" "}입력한 실적·일정·계획을 보고서 항목에 맞춰 배치
                  </li>
                  <li>
                    <b>
                      초안 검토
                    </b>
                    {" "}생성 내용을 확인하고 수정한 뒤 공식 문서로 활용
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <p>
                  회의 녹음과 참고 자료를 올리면 발언 내용을 구분하고 핵심 논의와 후속 업무를 회의록으로 정리합니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>
                    ...
                    {" "}STT와 화자 분리로 참석자별 발언 내용을 텍스트로 변환
                  </li>
                  <li>
                    <b>
                      내용 요약
                    </b>
                    {" "}주요 안건·결정 사항·담당 업무와 일정을 구분해 정리
                  </li>
                  <li>
                    <b>
                      회의록 완성
                    </b>
                    {" "}첨부 자료를 반영해 조직의 표준 회의록 양식으로 작성
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <p>
                  기안문과 보고서를 사내 규정·업무 지침과 자동으로 대조해 위반 가능성과 보완할 내용을 미리 확인합니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>
                    ...
                    {" "}PDF·DOCX·HWP와 스캔 문서의 내용을 읽을 수 있게 변환
                  </li>
                  <li>
                    <b>
                      규정 자동 대조
                    </b>
                    {" "}선택한 내규와 업무 지침에서 관련 조항을 찾아 비교
                  </li>
                  <li>
                    <b>
                      검토 결과 분류
                    </b>
                    {" "}위반 가능성과 보완 항목을 심각도와 근거별로 정리
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <p>
                  전문적인 SQL을 몰라도 업무 질문을 입력하면 필요한 데이터를 조회하고 결과를 표와 차트로 보여줍니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>
                    ...
                    {" "}자연어 요청에서 조회 대상과 조건을 파악해 SQL로 변환
                  </li>
                  <li>
                    <b>
                      권한 기반 조회
                    </b>
                    {" "}사용자가 접근할 수 있는 데이터베이스와 항목만 검색
                  </li>
                  <li>
                    <b>
                      결과 시각화
                    </b>
                    {" "}조회 결과와 조건을 표·차트·요약 설명으로 제공
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <p>
                  민감한 질문과 문서를 외부로 보내지 않고 내부망의 로컬 LLM에서만 처리해 안전하게 대화합니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>
                    ...
                    {" "}질문과 답변을 서버에 남기지 않는 독립 세션으로 처리
                  </li>
                  <li>
                    <b>
                      외부망 연결 차단
                    </b>
                    {" "}모든 추론과 문서 처리를 내부망 로컬 LLM에서 수행
                  </li>
                  <li>
                    <b>
                      AI 학습 미활용
                    </b>
                    {" "}입력한 대화와 참조 문서를 모델 학습 데이터로 사용하지 않음
                  </li>
                </ul>
                {" "}
            ...
            <div className="case-grid two">
              <article className="case-card reveal" data-d="1">
                ...
                <p className="csi">
                  ...
                  {" "}스캔 문서와 첨부 자료를 한 번에 접수
                </p>
                <p className="csi">
                  <b>
                    연계
                  </b>
                  {" "}OCR → 주소 표준화 → DB 조회 → 관련 규정 검색
                </p>
                <p className="csi">
                  <b>
                    산출물
                  </b>
                  {" "}확인 근거와 검토 항목을 담은 심사 보고서 초안
                </p>
              </article>
              <article className="case-card reveal" data-d="2">
                ...
                <p className="csi">
                  ...
                  {" "}거래 조건과 확인 대상 데이터를 지정
                </p>
                <p className="csi">
                  <b>
                    연계
                  </b>
                  {" "}DB 조회 → 데이터 분석 → 내규·법령 검색 → 보고서 작성
                </p>
                <p className="csi">
                  <b>
                    산출물
                  </b>
                  {" "}이상 징후, 판단 근거, 후속 확인 항목을 정리한 검토 문서
                </p>
              </article>
            </div>
