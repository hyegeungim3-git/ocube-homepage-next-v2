...
export default function ContactPage() {
  return (
    <>
      ...
      <meta name="description" content="오큐브(주) 프로젝트 문의 — 산업 AI·임베디드·SI·엔지니어링 지원. 대표전화 053-313-5333, sales@ocube.co.kr." />
      ...
      <meta property="og:description" content="오큐브(주) 프로젝트 문의 — 산업 AI·임베디드·SI·엔지니어링 지원. 대표전화 053-313-5333, sales@ocube.co.kr." />
      ...
      <meta name="twitter:description" content="오큐브(주) 프로젝트 문의 — 산업 AI·임베디드·SI·엔지니어링 지원. 대표전화 053-313-5333, sales@ocube.co.kr." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"문의\",\"item\":\"@@BASE@@contact.html\"}]}") }} />
          ...
          <div className="wrap">
            ...
            <form className="form reveal" data-contact-form="" data-d="1" aria-describedby="form-note form-status">
              <p id="form-note" className="form-note">
                입력한 내용은 이 웹사이트에 저장되지 않습니다. 제출하면 이메일 앱에서 내용을 확인하고 직접 보낼 수 있습니다.
              </p>
              <div>
              ...
              <div>
                ...
                <input id="f-name" name="name" type="text" autoComplete="name" placeholder="홍길동 / 회사명" required />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea id="f-msg" name="message" rows={6} placeholder="현재 상황과 해결하고 싶은 문제를 알려주세요." required></textarea>
              </div>
              {" "}
              <label className="agree">
                ...
                <wbr />
                이용에 동의합니다. 수집한 개인정보는 회신 및 상담 목적으로만 사용하며, 처리방침에 따라 보관·
                <wbr />
                파기합니다.
              </label>
              {" "}
            ...
            <div className="dep-grid">
              <div className="dep-card reveal" data-d="1">
                ...
                <p>
                  ...
                  {" "}
                  <button className="copy-btn" type="button" data-copy="sales@ocube.co.kr" aria-label="이메일 주소 복사">
                    복사
                  </button>
                </p>
              </div>
              <div className="dep-card reveal" data-d="2">
                ...
                <p>
                  ...
                  {" "}(서울){" "}
                  <button className="copy-btn" type="button" data-copy="053-313-5333" aria-label="대표전화 번호 복사">
                    복사
                  </button>
                </p>
              </div>
