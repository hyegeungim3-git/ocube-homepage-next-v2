...
export default function LicenseTuxeraPage() {
  return (
    <>
      <title>Tuxera — 파일 시스템 · 데이터 저장 | Global Partners · 오큐브(주)</title>
      <meta
        name="description"
        content="Reliance Nitro·FlashFX Tera 등 Tuxera 스토리지 솔루션 — 오큐브가 공급과 국내 엔지니어링 지원을 제공합니다."
      />
      ...
      <meta
        property="og:title"
        content="Tuxera — 파일 시스템 · 데이터 저장 | Global Partners · 오큐브(주)"
      />
      <meta
