...
export default function LicenseProtopiePage() {
  return (
    <>
      <title>
        ProtoPie — 하이피델리티 프로토타이핑 | Global Partners · 오큐브(주)
      </title>
      <meta name="description" content="코딩 없이 실제 제품에 가까운 인터랙션을 사전 검증하는 ProtoPie — 오큐브가 파트너로 공급·지원합니다." />
      ...
      <meta property="og:title" content="ProtoPie — 하이피델리티 프로토타이핑 | Global Partners · 오큐브(주)" />
      <meta property="og:description" content="코딩 없이 실제 제품에 가까운 인터랙션을 사전 검증하는 ProtoPie — 오큐브가 파트너로 공급·지원합니다." />
      ...
      <meta name="twitter:title" content="ProtoPie — 하이피델리티 프로토타이핑 | Global Partners · 오큐브(주)" />
      <meta name="twitter:description" content="코딩 없이 실제 제품에 가까운 인터랙션을 사전 검증하는 ProtoPie — 오큐브가 파트너로 공급·지원합니다." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"ProtoPie\",\"item\":\"@@BASE@@license-protopie.html\"}]}") }} />
