...
export default function BusinessEmbeddedPage() {
  return (
    <>
      <title>
        Embedded · 임베디드 소프트웨어 — 오큐브
      </title>
      <meta name="description" content="오큐브 임베디드 — 글로벌 완성차 7개 그룹 양산에서 검증한 차량 전장·산업용 디바이스 SW를 요구 분석부터 통합 검증·양산 대응까지 개발합니다." />
      ...
      <meta property="og:description" content="오큐브 임베디드 — 글로벌 완성차 7개 그룹 양산에서 검증한 차량 전장·산업용 디바이스 SW를 요구 분석부터 통합 검증·양산 대응까지 개발합니다." />
        ...
        <section className="hero page-hero business-hero dark">
          ...
          <div className="wrap business-hero-copy">
            ...
            <h1 className="business-hero-ko">
              ...
              {" "}
              <span>
                혁신적인 소프트웨어로 스마트한 연결과 제품의 차별화를 완성합니다.
              </span>
              {" "}
            </h1>
          </div>
        ...
        <section className="pinsec" id="whatwedo">
          <div className="wrap">
            <div className="pin-left">
              ...
              <p>
                요구 정의부터 양산 검증까지, V-모델 아키텍처에 기반한 체계적인 프로세스로 하드웨어 제약과 안전·
                <wbr />
