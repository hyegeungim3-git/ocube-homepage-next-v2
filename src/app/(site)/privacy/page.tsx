...
export default function PrivacyPage() {
  return (
    <>
      ...
      <meta name="description" content="오큐브(주) 개인정보처리방침 — 문의 시 수집하는 개인정보 항목·이용 목적·보유 기간·이용자 권리 안내." />
      ...
      <meta property="og:description" content="오큐브(주) 개인정보처리방침 — 문의 시 수집하는 개인정보 항목·이용 목적·보유 기간·이용자 권리 안내." />
      ...
      <meta name="twitter:description" content="오큐브(주) 개인정보처리방침 — 문의 시 수집하는 개인정보 항목·이용 목적·보유 기간·이용자 권리 안내." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"개인정보처리방침\",\"item\":\"@@BASE@@privacy.html\"}]}") }} />
        ...
        <section className="sec deploy">
          <div className="wrap" style={{maxWidth: "860px"}}>
            ...
            <div style={{background: "var(--soft)", border: "1px solid var(--accent)", borderRadius: "12px", padding: "16px 20px", color: "var(--fg-muted)", marginBottom: "30px", lineHeight: "1.6"}}>
              ...
              {" "}— 문의 폼에 입력한 내용은 홈페이지 서버에 저장되거나 자동 전송되지 않습니다. 제출하면 사용자의 이메일 앱이 열리며, 메일을 직접 전송한 경우에만 오큐브가 문의 내용을 수신합니다.{" "}
            </div>
            ...
            <p>
              ...
              <br className="sb" />
              {" "}사용자가 이메일 문의를 직접 전송하면 상담을 위해 아래 정보가 수신될 수 있습니다.
            </p>
            <ul style={{margin: "10px 0 0 18px", lineHeight: "1.9"}}>
              <li>
                성함 또는 회사명, 회신 이메일, 문의 유형과 문의 내용
              </li>
              <li>
                홈페이지에서 자동 수집하는 항목: 없음
              </li>
            </ul>
            ...
            <p>
              이메일로 수신한 정보는 문의 회신과 상담에 필요한 기간 동안 처리하고, 목적이 달성되면 지체 없이 파기합니다.
              <br className="sb" />
              {" "}다만 관계 법령에 따라 보존이 필요한 경우에는 해당 기간 동안 보관합니다.
            </p>
            <h2 style={{fontSize: "21px", margin: "30px 0 8px"}}>
            ...
            <p>
              ...
              <br className="sb" />
              {" "}사용자가 이메일 앱에서 직접 발송한 경우에는 해당 이메일 서비스의 정책과 전송 경로가 적용됩니다.
            </p>
            <p style={{marginTop: "10px"}}>
              사이트는 화면 표시와 위치 안내를 위해 jsDelivr의 웹폰트와 Google 지도 콘텐츠를 불러옵니다.
              <br className="sb" />
              {" "}이 과정에서 IP 주소, 브라우저 정보, 접속 기록 등이 각 서비스 제공자에게 전달될 수 있으며, 처리는 해당 제공자의 정책을 따릅니다.
            </p>
            <h2 style={{fontSize: "21px", margin: "30px 0 8px"}}>
              5. 이용자의 권리
            </h2>
            ...
            <p>
              홈페이지 문의와 개인정보 처리에 관한 요청은 아래 연락처로 보내주시기 바랍니다.
            </p>
            <ul style={{margin: "10px 0 0 18px", lineHeight: "1.9"}}>
              <li>
                이메일:{" "}
