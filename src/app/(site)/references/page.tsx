...
export default function ReferencesPage() {
  return (
    <>
      ...
      <meta name="description" content="오큐브(주) 주요 구축 사례 — 제조·에너지·모빌리티·공공·금융·홈 AIoT·기업서비스. 산업 분야별 레퍼런스와 AX·임베디드·SI 역량을 과제-해결-성과로 정리했습니다." />
      ...
      <meta property="og:description" content="제조·에너지·모빌리티·공공·금융·홈 AIoT·기업서비스 — 산업 분야별 구축 사례를 과제-해결-성과로 정리했습니다." />
      ...
      <meta name="twitter:description" content="제조·에너지·모빌리티·공공·금융·홈 AIoT·기업서비스 — 산업 분야별 구축 사례." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"회사\",\"item\":\"@@BASE@@company.html\"},{\"@type\":\"ListItem\",\"position\":3,\"name\":\"주요 구축 사례\",\"item\":\"@@BASE@@references.html\"}]}") }} />
        ...
        <section id="refs" className="sec">
          <div className="wrap">
            <div className="sec-head center rv">
              ...
              <p className="lead">
                실제 적용 분야를 선택해 사례를 모아 보고, 배지와 정보 블록에서 거래 유형·발주처·분야를 바로 확인할 수 있습니다.
              </p>
            </div>
            <div className="case-filter cert-filter rv d2" role="group" aria-label="산업 도메인 필터" style={{position: "static", background: "none", border: "0", padding: "0", marginTop: "clamp(28px,3.4vw,44px)"}}>
              {" "}
