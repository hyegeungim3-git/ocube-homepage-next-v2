...
export default function SolutionCubeonPage() {
  return (
    <>
      <title>Cubeon 산업 AI 운영 플랫폼 — 오큐브</title>
      <meta
        name="description"
        content="Cubeon — 산업 데이터를 표준화하고 AI 판단을 담당자 승인과 검증된 범위의 제한적 자동 실행으로 연결하는 산업 AI 운영 플랫폼."
      />
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>데이터에서 실행까지 이어지는 여섯 개 코어 모듈</h2>
              <p className="lead">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Data Foundation</span> <h3>데이터 통합 관리</h3>
                <p>
                  기업 내 다양한 정형·
                  <wbr />
                  비정형·
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>정제 파이프라인</b> 연결 → 파싱 → 정제 → 표준화 → 데이터셋 생성
                  </li>
                  <li>
                    <b>품질 점검</b> 완전성·
                    <wbr />
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>시맨틱 모델</b> 온톨로지 스키마와 프로퍼티 매핑 관리
                  </li>
                  <li>
                    <b>개정 이력</b> 온톨로지 버전과 도메인 분류 체계 관리
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">AI Agent</span> <h3>지식 기반 AI Agent 서비스</h3>
                <p>
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>게이트웨이 라우팅</b> 업무별 모델 배분과 응답 지연·
                    <wbr />
                    처리량 관리
                  </li>
                  <li>
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Workflow & Action</span> <h3>업무 자동화 및 실행 관리</h3>
                <p>
                  AI의 분석 결과를 시스템 조회, 문서 생성, 알림, 승인, 업무 처리까지 연결합니다.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>폐루프 실행</b> 검색 → 분석 → 권고 → 승인 → 실행 연결
                  </li>
                  <li>
                    <b>승인 라우팅</b> 승인 대기함과 우선순위·
                    <wbr />
                    지연 경고 관리
                  </li>
                  <li>
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <p>
                  기업 AI 환경에 필요한 데이터 접근권한, Agent 권한, 로그, 모델 및 지식 버전을 통합
                  관리합니다.
                </p>
                <ul className="pi-bul">
                  <li>
            ...
            <div className="pin-right">
              <article className="pin-item reveal">
                ...
                <div className="pi-tags">
                  <span className="pill light">산업 통신 표준</span>
                  <span className="pill light">시스템 연계 API</span>
                </div>{" "}
                <button
                  type="button"
                  className="pi-shot"
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    <b>운영 상태 추적</b> 데이터 수집부터 제어까지 각 단계의 지연과 오류율을 측정해
                    문제 구간 확인
                  </li>
                  <li>
                    <b>단계적 확장</b> 라인 1개 검증에서 전사 확산까지 검증된 처리 구조 재사용
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">실시간 처리</span>
                  <span className="pill light">정기 처리</span>
                </div>{" "}
                <button
                  type="button"
                  className="pi-shot"
              ...
              <article className="pin-item reveal">
                ...
                <div className="pi-tags">
                  <span className="pill light">산업 용어·관계 체계(온톨로지)</span>
                </div>{" "}
                <button
                  type="button"
                  className="pi-shot"
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    <b>데이터 변화 탐지</b> 입력 데이터와 예측 결과의 변화를 확인해 재학습 시점 판단
                  </li>
                  <li>
                    <b>감사 이력</b> 모델의 판단과 실행 전 과정을 기록해 품질·
                    <wbr />
                    규정 대응 지원
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">학습·검증·배포·재학습</span>
                </div>{" "}
                <button
                  type="button"
                  className="pi-shot"
              ...
              <article className="pin-item reveal">
                ...
                <h3>전문 AI 에이전트</h3>
                <p>업무 질문에 답하고 문서를 분석하며 업무를 수행하는 AI 에이전트를 실행합니다.</p>
                <ul className="pi-bul">
                  <li>
                    <b>근거 제시</b> 검색한 문서·
                    <wbr />
                  ...
                  <li>
                    <b>권한 인지</b> 역할 기반 접근 제어로 사용자별 참조 가능한 지식·
                    <wbr />
                    기능 범위 분리
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">검색 증강 생성(RAG)</span>
              ...
              <article className="pin-item reveal">
                ...
                <div className="pi-tags">
                  <span className="pill light">AI 도구·시스템 연결</span>
                </div>{" "}
                <button
                  type="button"
                  className="pi-shot"
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>데이터 경계 고정</b> 외부 반출 제한 데이터가 경계를 넘지 않도록 처리 위치를
                    정책으로 고정
                  </li>
                </ul>{" "}
                <button
        ...
        <section id="structure" className="sec-anchor platform dark">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2>공통 코어 위에 필요한 분야 기능을 확장합니다</h2>
              <p className="sec-sub">
                데이터·
                <wbr />
                AI·
            ...
            <div className="prod-row reveal" data-d="1">
              <article className="prod-card">
                <h3>Horizontal Core</h3> <span className="sub">공통 운영 기반</span>{" "}
                <p>
                  Connect부터 Console까지 8개 모듈을 조합해 데이터 연결, AI 운영, 승인과 실행의 공통
                  기준을 만듭니다.
                </p>
              </article>
              <article className="prod-card">
                <h3>Manufacturing Pack</h3> <span className="sub">제조 도메인팩</span>{" "}
                <p>
                  설비 이상 감지·
                  <wbr />
                  예지보전·
              ...
              <article className="prod-card">
                <h3>Safety Pack</h3> <span className="sub">안전 도메인팩</span>{" "}
                <p>
                  영상·
                  <wbr />
                  센서·
              ...
              <article className="prod-card">
                <h3>Copilot</h3> <span className="sub">업무 지식 서비스</span>{" "}
                <p>
        ...
        <section id="operation" className="sec-anchor">
          <div className="wrap">
            ...
            <div className="reveal" data-d="1" style={{ marginTop: "72px" }}>
              <span className="kicker">Deployment</span> <h2>데이터와 보안 요건에 맞는 배포</h2>
              <p className="sec-sub">
