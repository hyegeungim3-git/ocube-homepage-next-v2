...
export default function SolutionTrafficPage() {
  return (
    <>
      <title>
        QVision 영상 인식 교통·안전 — 오큐브
      </title>
      <meta name="description" content="QVision — 영상 인식(Vision) AI로 교통을 분석하고 도로·작업 위험을 감지합니다." />
      ...
      <meta property="og:description" content="QVision — 영상 인식(Vision) AI로 교통을 분석하고 도로·작업 위험을 감지합니다." />
      ...
      <meta name="twitter:description" content="QVision — 영상 인식(Vision) AI로 교통을 분석하고 도로·작업 위험을 감지합니다." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"QVision\",\"item\":\"@@BASE@@solution-traffic.html\"}]}") }} />
          ...
          <section className="sol-intro">
            ...
            <div className="sol-body">
              <figure className="sol-stage rv d3">
                {" "}
                <img src="assets/img/qvision-intro.png" alt="QVision — AI 기반 교통 분석·안전 모니터링·스마트 관제 구성" loading="lazy" width="1672" height="941" />
                {" "}
              </figure>
            </div>
          </section>
        ...
        <section id="overview" className="sec-anchor">
          <div className="wrap">
            ...
            <div className="media-duo overview-balanced reveal" data-d="1">
              <figure>
                <img className="shot" src="assets/img/proto/qvision-overview.jpg" alt="QVision AI 비전 기반 교통 분석·안전 솔루션 구성 — 영상 입력원부터 차량 인식·보행자 감지·교통량 분석·이상행동 감지·사고 알림·통합 관제 연계까지" loading="lazy" width="1600" height="900" />
                {" "}
              </figure>
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              {" "}
              <h2>
                영상 속 차량과 도로 위험 상황을 실시간으로 분석합니다
              </h2>
              <p className="lead">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}지나는 차량을 종류별로 구분해 통행량 자동 집계
                  </li>
                  <li>
                    <b>
                      교차로 방향별 추적
                    </b>
                    {" "}교차로 진행 방향별 교통량을 구분해 집계
                  </li>
                  <li>
                    <b>
                      고정식·
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img src="assets/img/tms.png" alt="TMS 실시간 교통량 검출 화면 — 차종 분류·통행량 계측" loading="lazy" width="560" height="204" />
                {" "}
              </div>
            </div>
            <div className="duo rev">
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img src="assets/img/pothole.png" alt="포트홀 실시간 검출 데모 화면 — 차량 영상 인식 모듈과 관제 서버" loading="lazy" width="600" height="211" />
                {" "}
              </div>
            </div>
          </div>
          ...
          <div className="wrap">
            ...
            <div className="feat-list tms-metrics reveal" data-d="1">
              ...
              <div className="feat">
                ...
                <span>
                  국토교통부 기준 12차종에서 버스까지 총 13차종 구분
                </span>
              </div>
              <div className="feat">
                <i className="tms-no" aria-hidden="true">
        ...
        <section id="detect" className="sec-anchor dark">
          <div className="wrap">
            ...
            <p className="sec-note">
              검지 항목은 운영 요건에 맞춰 확장하며, 오탐을 줄이기 위해 사람 검수 단계를 둘 수 있습니다. 개인영상정보 비식별 처리는 운영 요건과 관련 규정에 따라 적용합니다.
            </p>
