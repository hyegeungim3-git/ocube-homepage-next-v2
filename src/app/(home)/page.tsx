...
export default function HomePage() {
  return (
    <>
      <title>
        오큐브(주) — Embedded에서 AI까지 · 산업 AI 솔루션 기업
      </title>
      <meta name="description" content="오큐브(주)는 임베디드·SI 기술력 위에 자체 산업 AI 플랫폼 Cubeon을 더해 제조·모빌리티·에너지와 기업 운영의 과제를 해결하는 산업 AI 솔루션 기업입니다. Since 2007." />
      ...
      <meta property="og:description" content="오큐브(주)는 임베디드·SI 기술력 위에 자체 산업 AI 플랫폼 Cubeon을 더해 제조·모빌리티·에너지와 기업 운영의 과제를 해결하는 산업 AI 솔루션 기업입니다. Since 2007." />
      ...
      <meta name="twitter:description" content="오큐브(주)는 임베디드·SI 기술력 위에 자체 산업 AI 플랫폼 Cubeon을 더해 제조·모빌리티·에너지와 기업 운영의 과제를 해결하는 산업 AI 솔루션 기업입니다. Since 2007." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"Organization\",\"name\":\"오큐브 주식회사\",\"alternateName\":\"OCUBE Co., Ltd.\",\"url\":\"@@BASE@@\",\"logo\":\"@@BASE@@assets/og-image.jpg\",\"foundingDate\":\"2007-03-29\",\"description\":\"임베디드·SI 기반의 산업 AI 솔루션 기업\",\"address\":{\"@type\":\"PostalAddress\",\"streetAddress\":\"수성구 알파시티1로31길 18\",\"addressLocality\":\"대구광역시\",\"addressCountry\":\"KR\"},\"telephone\":\"+82-53-313-5333\",\"email\":\"sales@ocube.co.kr\"}") }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"WebSite\",\"name\":\"오큐브(주)\",\"url\":\"@@BASE@@\"}") }} />
      ...
      <main>
            ...
            <div className="hero-ctrl">
              <div className="wrap">
                <div className="hctrl">
                  ...
                  {" "}
                  <button className="hnav" type="button" data-act="toggle" aria-label="자동 전환 일시정지" aria-pressed="false">
                    {" "}
                ...
                <div className="hpag" role="tablist" aria-label="히어로 배너 선택">
                  {" "}
                  <button className="hbar hpag-item on" type="button" data-i="0" aria-label="AX 슬라이드">
                    <i></i>
                    <span>
                      01
                    </span>
                  ...
                  {" "}
                  <button className="hbar hpag-item" type="button" data-i="1" aria-label="Embedded 슬라이드">
                    <i></i>
                    <span>
                      02
                    </span>
                  ...
                  {" "}
                  <button className="hbar hpag-item" type="button" data-i="2" aria-label="SI 슬라이드">
                    <i></i>
                    <span>
                      03
                    </span>
                  ...
                  {" "}
                  <button className="hbar hpag-item" type="button" data-i="3" aria-label="GLOBAL TECH 슬라이드">
                    <i></i>
                    <span>
                      04
                    </span>
          ...
          <div className="typo-layout">
            ...
            <div className="typo-copy">
              <p>
                ...
                (견고한 기술)가 만나 탄생했습니다.{" "}
                <br />
                고객의 과제를 이해하고 AX · 임베디드 · SI 역량으로 운영 가능한 제품과 시스템을 구축합니다.
              </p>
              {" "}
              <a href="#business">
                자세히 보기{" "}
        ...
        <section id="business" className="capabilities-section">
          ...
          <div className="capabilities-grid">
            <article className="capability-card is-active" aria-current="true">
              ...
              <p>
                데이터와 AI를 통해 더 나은 판단과 빠른 실행을 연결하고, 기업과 산업의 운영 방식을 혁신합니다.
              </p>
            ...
            <article className="capability-card">
              ...
              <p>
                모빌리티부터 산업용 디바이스까지, 혁신적인 소프트웨어로 스마트한 연결과 제품의 차별화를 완성합니다.
              </p>
              <div className="capability-chips">
                <span>
                  AUTOMOTIVE
            ...
            <article className="capability-card">
              ...
              <p>
                고객의 요구를 안정적인 시스템으로 구현하고 연결하여, 더 효율적인 비즈니스 환경을 만듭니다.
              </p>
              <div className="capability-chips">
                <span>
                  BUSINESS
        ...
        <section id="partners" className="global-tech-section" aria-labelledby="home-partner-title">
          <div className="global-tech-copy">
            ...
            <p>
              제품 선정과 정품 라이선스 공급부터 포팅·통합·커스터마이징·엔지니어링 지원까지 오큐브 엔지니어가 함께합니다.
            </p>
          </div>
        ...
        <section id="references" className="bcase home-cases-section">
          <div className="home-cases-sticky">
            <div className="home-case-opening">
              <h2>
                산업의 요구를 이해하고, 실제 운영으로 증명한 구축 사례
              </h2>
            </div>
            <div className="home-cases-panel">
              <div id="case-content" className="bcase-head">
                ...
                <p>
                  산업의 요구를 정확히 이해하고, 실제 운영 환경에서 안정적으로 작동하는 소프트웨어와 시스템으로 완성한 오큐브의 프로젝트입니다.
                </p>
              </div>
            ...
            <div className="contact-top">
              <div className="contact-copy">
                ...
                <p className="contact-description">
                  남겨주신 내용은 담당 엔지니어가 직접 확인해, 도입 상담부터 기술 문의와 라이선스 견적까지 안내드립니다.
                </p>
                {" "}
              ...
              <div className="contact-company">
                ...
                <dl>
                  ...
                  <div>
                    ...
                    <dd>
                      안양 동안구 LS로 142 금정역SKV1센터 722·723·710호
                    </dd>
                  </div>
                </dl>
              </div>
