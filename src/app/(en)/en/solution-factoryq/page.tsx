...
export default function SolutionFactoryqPage() {
  return (
    <>
      <title>
        QFactory · AI Smart Factory — OCUBE
      </title>
      <meta name="description" content="QFactory — an AI smart factory platform that joins process, equipment, quality, energy and safety data, and takes it from prediction and optimisation through to approval-based operation." />
      ...
      <meta property="og:description" content="QFactory — an AI smart factory platform that joins process, equipment, quality, energy and safety data, and takes it from prediction and optimisation through to approval-based operation." />
      ...
      <meta name="twitter:description" content="QFactory — an AI smart factory platform that joins process, equipment, quality, energy and safety data, and takes it from prediction and optimisation through to approval-based operation." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"QFactory\",\"item\":\"@@BASE@@en/solution-factoryq.html\"}]}") }} />
        ...
        <section id="applications" className="sec-anchor factory-apps">
          <div className="wrap">
            ...
            <p className="factory-note rv d1">
              ...
              {" "}Nothing is ripped out. Add-on sensors and edge systems sit alongside what you have, and coverage grows from the process that needs it most.
            </p>
              ...
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}Product, weight, thickness and the rest
                  </li>
                  <li>
                    <b>
                      Generating the profile
                    </b>
                    {" "}Target temperature and hold time designed from successful cycles and AI prediction
                  </li>
                  <li>
                    <b>
                      Applied only on approval
                    </b>
                    {" "}The reasoning and expected outcome are shown, and a person accepts or declines
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
              ...
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    {" "}Departures from the normal pattern recorded with severity and likely cause
                  </li>
                  <li>
                    <b>
                      Operator action
                    </b>
                    {" "}Warnings acknowledged, the process halted, and what was done kept on record
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
              ...
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}Temperature, vacuum, process step and logs synchronised on one timeline
                  </li>
                  <li>
                    <b>
                      Replayed in 3D
                  ...
                  <li>
                    ...
                    {" "}Detection scores compared against sensor movement to shortlist the cause
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
              ...
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    {" "}The weak measures are found and put in order of priority
                  </li>
                  <li>
                    <b>
                      Comparing cycles
                    </b>
                    {" "}Performance by period and cycle, and whether the recommendation actually helped
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
              ...
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    {" "}Compared against the current version; only an approved model goes in
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <table className="cmp reveal" data-d="1">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    Alarms once a fixed limit is passed — after the fact
                  </td>
                  <td className="ok">
                ...
                <tr>
                  ...
                  <td>
                    Someone traces the logs by hand
                  </td>
                  <td className="ok">
                ...
                <tr>
                  ...
                  <td>
                    The recipe stays as it is
                  </td>
                  <td className="ok">
                    A profile recommended from condition and quality data
                  </td>
                </tr>
                <tr>
                  <th scope="row">
                  ...
                  <td>
                    By schedule, or after it breaks
                  </td>
                  <td className="ok">
                    Predictive, based on remaining useful life
                  </td>
                </tr>
                <tr>
                  <th scope="row">
                  ...
                  <td>
                    Tuned by hand, then left alone
                  </td>
                  <td className="ok">
                    Data shifts watched, models retrained
                  </td>
                </tr>
              </tbody>
            </table>
