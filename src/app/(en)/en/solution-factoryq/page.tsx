  ...
  return (
    <>
      <PageMeta
        ...
        title="QFactory · AI Smart Factory — OCUBE"
        description="QFactory — an AI smart factory platform that joins process, equipment, quality, energy and safety data, and takes it from prediction and optimisation through to approval-based operation."
      />
      <script
