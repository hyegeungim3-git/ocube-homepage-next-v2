...
export default function SolutionTrafficPage() {
  return (
    <>
      <title>
        QVision · Vision AI for Traffic and Safety — OCUBE
      </title>
      <meta name="description" content="QVision — vision AI that analyses traffic and detects hazards on the road and at work." />
      ...
      <meta property="og:description" content="QVision — vision AI that analyses traffic and detects hazards on the road and at work." />
      ...
      <meta name="twitter:description" content="QVision — vision AI that analyses traffic and detects hazards on the road and at work." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"QVision\",\"item\":\"@@BASE@@en/solution-traffic.html\"}]}") }} />
