...
export default function LicenseVisualonPage() {
  return (
    <>
      <title>
        VisualOn — Multimedia Playback SDKs | Global Partners · OCUBE
      </title>
      <meta name="description" content="The VisualOn multimedia range, including OnStream MediaPlayer+ — supplied by OCUBE, with engineering support in Korea." />
      ...
      <meta property="og:title" content="VisualOn — Multimedia Playback SDKs | Global Partners · OCUBE" />
      <meta property="og:description" content="The VisualOn multimedia range, including OnStream MediaPlayer+ — supplied by OCUBE, with engineering support in Korea." />
      ...
      <meta name="twitter:title" content="VisualOn — Multimedia Playback SDKs | Global Partners · OCUBE" />
      <meta name="twitter:description" content="The VisualOn multimedia range, including OnStream MediaPlayer+ — supplied by OCUBE, with engineering support in Korea." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"VisualOn\",\"item\":\"@@BASE@@en/license-visualon.html\"}]}") }} />
          ...
          <div className="wrap">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                {" "}
                <h3>
                  A premium player SDK with the streaming features an OTT service needs
                </h3>
                <p>
                  The VisualOn Multimedia Player Stack delivers{" "}
                  <b>
                    consistent delivery and playback
                  </b>
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                {" "}
                <h3>
                  A streaming solution that works with the platform’s own player API
                </h3>
                <p>
                  It plugs into the native player APIs — Android ExoPlayer, iOS AVPlayer and the rest.
                  <br className="sb" />
                  {" "}Analytics, content protection and AdFlow management are included.
                </p>
              </div>
              <div className="duo-media plain rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                {" "}
                <span className="pill">
                  HTML5 Player+ · UX monitor
                </span>
                {" "}
                <h3>
                  Watching playback quality and user experience in the browser
                </h3>
                <p>
                  In HTML5 it gives a{" "}
                  <b>
                    steady in-browser playback experience
                  </b>
                  .
                  <br className="sb" />
                  {" "}The UX monitor collects quality-of-service data in the cloud.
                </p>
              </div>
              <div className="duo-media plain rv d1">
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                {" "}
                <h3>
                  Software codecs and parsers tuned for mobility
                </h3>
                <p>
                  VisualOn’s software codecs can be tuned per environment, balancing the picture quality you want against processing and power.
                </p>
                <div className="pi-tags">
                  <span className="pill light">
                    H.265/HEVC
