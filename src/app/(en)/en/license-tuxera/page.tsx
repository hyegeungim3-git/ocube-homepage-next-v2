...
export default function LicenseTuxeraPage() {
  return (
    <>
      <title>
        Tuxera — File Systems and Storage | Global Partners · OCUBE
      </title>
      <meta name="description" content="Tuxera storage software, including Reliance Nitro and FlashFX Tera — supplied by OCUBE, with engineering support in Korea." />
      ...
      <meta property="og:title" content="Tuxera — File Systems and Storage | Global Partners · OCUBE" />
      <meta property="og:description" content="Tuxera storage software, including Reliance Nitro and FlashFX Tera — supplied by OCUBE, with engineering support in Korea." />
      ...
      <meta name="twitter:title" content="Tuxera — File Systems and Storage | Global Partners · OCUBE" />
      <meta name="twitter:description" content="Tuxera storage software, including Reliance Nitro and FlashFX Tera — supplied by OCUBE, with engineering support in Korea." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Tuxera\",\"item\":\"@@BASE@@en/license-tuxera.html\"}]}") }} />
          ...
          <div className="wrap">
              ...
              <div className="duo-txt rv">
                <div className="feat-list">
                  <div className="feat">
                    ...
                    <p>
                      A high-performance file system for embedded Linux and VxWorks — data stays intact even when the power cuts out
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
                    ...
                    <p>
                      Managing the life and performance of NAND and NOR flash — used in safety-critical systems across automotive, aerospace and medical
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="feat-list rv" style={{marginTop: "8px"}}>
              <div className="feat">
                ...
                <p>
                  Reading and writing Windows NTFS drives on a Mac — transfers, disk management, dual boot and virtual machines
                </p>
              </div>
              <div className="feat">
                <h3>
                ...
                <p>
                  Enterprise-grade network file sharing — a fast, flexible SMB server built for cloud and NAS
                </p>
              </div>
              <div className="feat">
                <h3>
                ...
                <p>
                  SMB and NTFS running steadily at scale in networks and cloud — with quicker access and search
                </p>
              </div>
            </div>
