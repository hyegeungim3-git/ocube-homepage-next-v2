...
export default function BusinessSiPage() {
  return (
    <>
      <title>
        SI · Systems Integration — OCUBE
      </title>
      <meta name="description" content="OCUBE SI — analysing complex B2B and B2G operations and delivering them as stable systems, through design, development, integration testing, cutover and operation." />
      ...
      <meta property="og:description" content="OCUBE SI — analysing complex B2B and B2G operations and delivering them as stable systems, through design, development, integration testing, cutover and operation." />
      ...
      <meta name="twitter:description" content="OCUBE SI — analysing complex B2B and B2G operations and delivering them as stable systems, through design, development, integration testing, cutover and operation." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"SI\",\"item\":\"@@BASE@@en/business-si.html\"}]}") }} />
      <SiteHeader slug="business-si" lang="en" />
      <MobilePanel lang="en" />
      <main id="top">
        {/* 1. HERO (풀스크린 · 이미지) */}
        <section className="hero page-hero business-hero dark">
          <div className="hero-bg" style={{backgroundImage: "url('../assets/img/business/business-si-codex.webp')"}} aria-hidden="true"></div>
          <div className="hero-veil" aria-hidden="true"></div>
          <div className="wrap business-hero-copy">
            <p className="business-hero-en">
              SI, From Business to Systems.
            </p>
            <h1 className="business-hero-ko">
              {" "}
              <span>
                Business needs, built into stable systems —
              </span>
              {" "}
              <span>
                so everyday work runs better.
              </span>
              {" "}
            </h1>
          </div>
          ...
          <div className="pcl-mq">
            <div className="pcl-track">
              <div className="pcl-logo">
                <img src="../assets/img/client/lg-electronics.png" alt="LG Electronics" loading="lazy" width="280" height="90" />
              </div>
              <div className="pcl-logo">
                <img src="../assets/img/client/sk-energy.png" alt="SK Energy" loading="lazy" width="280" height="90" />
              </div>
              <div className="pcl-logo">
          ...
          <div className="wrap">
            <div className="pin-left">
              ...
              <p>
                ...
                <br className="sb" />
                {" "}Six steps, from gathering requirements to go-live and operation.
              </p>
        ...
        <section id="projects" className="bcase">
          <div className="bcase-head rv">
            ...
            <p>
              See which systems we built for which work — and how far we ran them afterwards.
            </p>
          </div>
          <div className="wrap">
