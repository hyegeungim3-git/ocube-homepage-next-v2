...
export default function LicenseQtPage() {
  return (
    <>
      <title>
        Qt — Cross-Platform UI Framework | Global Partners · OCUBE
      </title>
      <meta name="description" content="Qt — one framework and one codebase across desktop and embedded platforms, with licence supply and engineering support in Korea from OCUBE." />
      ...
      <meta property="og:title" content="Qt — Cross-Platform UI Framework | Global Partners · OCUBE" />
      <meta property="og:description" content="Qt — one framework and one codebase across desktop and embedded platforms, with licence supply and engineering support in Korea from OCUBE." />
      <meta property="og:url" content={withBase("en/license-qt.html")} />
      <meta property="og:image" content={withBase("og-codex.png")} />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="Qt — Cross-Platform UI Framework | Global Partners · OCUBE" />
      <meta name="twitter:description" content="Qt — one framework and one codebase across desktop and embedded platforms, with licence supply and engineering support in Korea from OCUBE." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Qt\",\"item\":\"@@BASE@@en/license-qt.html\"}]}") }} />
              ...
              <div className="duo-txt rv">
                <div className="feat-list">
                  <div className="feat">
                    ...
                    <p>
                      Core libraries common to the major platforms — with binary and source compatibility guaranteed under Qt’s versioning policy
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
                    ...
                    <p>
                      Graphics, networking, multimedia and whatever else the platform calls for
                    </p>
                  </div>
                </div>
            ...
            <div className="duo rev" style={{marginTop: "8px"}}>
              <div className="duo-txt rv">
                <div className="feat-list">
                  <div className="feat">
                    <h3>
                      The Qt Creator environment
                    </h3>
                    <p>
                      Editing the interface, completing the code, debugging visually and profiling — in one place
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
                    ...
                    <p>
                      qmake and CMake keep the build simple
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
                    ...
                    <p>
                      Unit tests on Qt Test, with GUI automation tools brought in per project
                    </p>
                  </div>
                </div>
                <div className="hero-ctas" style={{marginTop: "22px"}}>
          ...
          <div className="wrap">
            ...
            <div className="dep-grid reveal" data-d="1" style={{marginTop: "26px"}}>
              <div className="dep-card">
                ...
                <p>
                  Which Qt licence suits the size of the project and the target device
                </p>
              ...
              <div className="dep-card">
                ...
                <p>
                  Genuine licences supplied and renewed, with compliance looked after
                </p>
                <a className="sec-more" href="contact.html">
                  Get in touch →
                </a>
              ...
              <div className="dep-card">
                ...
                <p>
                  From the first evaluation through training to integration engineering
                </p>
                <a className="sec-more" href="contact.html">
                  Get in touch →
                </a>
          ...
          <div className="wrap">
            ...
            <div className="dep-grid">
              <div className="dep-card rv">
                ...
                <p>
                  Qt ported to the Qualcomm APQ8009
                </p>
              </div>
              <div className="dep-card rv d1">
                ...
                <p>
                  Monitoring software for a system air conditioner
                </p>
              </div>
              ...
              <div className="dep-card rv d3">
                ...
                <p>
                  Mobile app for an audio matrix controller
                </p>
              </div>
            </div>
