...
export default function LicenseProtopiePage() {
  return (
    <>
      <title>
        ProtoPie — High-Fidelity Prototyping | Global Partners · OCUBE
      </title>
      <meta name="description" content="ProtoPie lets you try out interactions that behave like the real product, without code — supplied and supported by OCUBE as a partner." />
      ...
      <meta property="og:title" content="ProtoPie — High-Fidelity Prototyping | Global Partners · OCUBE" />
      <meta property="og:description" content="ProtoPie lets you try out interactions that behave like the real product, without code — supplied and supported by OCUBE as a partner." />
      ...
      <meta name="twitter:title" content="ProtoPie — High-Fidelity Prototyping | Global Partners · OCUBE" />
      <meta name="twitter:description" content="ProtoPie lets you try out interactions that behave like the real product, without code — supplied and supported by OCUBE as a partner." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"ProtoPie\",\"item\":\"@@BASE@@en/license-protopie.html\"}]}") }} />
              ...
              <div className="duo-txt rv">
                <div className="feat-list">
                  <div className="feat">
                    ...
                    <p>
                      Variables and conditions handle complex transitions and responses, with no code written
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
                    ...
                    <p>
                      Prototypes that talk between phone, tablet, PC and wearable, so the real service flow can be tried
                    </p>
                  </div>
                  <div className="feat">
                    <h3>
                  ...
                  <div className="feat">
                    ...
                    <p>
                      Repeated interactions kept as components — consistent across screens, and quicker to make
                    </p>
                  </div>
                </div>
              </div>
              <div className="duo-media plain rv d1">
                <img src="../assets/img/vendor/protopie.png" alt="ProtoPie 인터랙션 프로토타이핑 화면" loading="lazy" width="665" height="524" />
              </div>
            </div>
          </div>
        </section>
