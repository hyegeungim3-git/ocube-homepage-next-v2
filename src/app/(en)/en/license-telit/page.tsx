...
export default function LicenseTelitPage() {
  return (
    <>
      <title>Telit Cinterion — Cellular IoT Modules | Global Partners · OCUBE</title>
      <meta
        name="description"
        content="Telit Cinterion modules for M2M and IoT applications — supplied by OCUBE, with engineering support in Korea."
      />
      ...
      <meta
        property="og:title"
        content="Telit Cinterion — Cellular IoT Modules | Global Partners · OCUBE"
      />
      <meta
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: applyBase(
            '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"홈","item":"@@BASE@@en/"},{"@type":"ListItem","position":2,"name":"Telit Cinterion","item":"@@BASE@@en/license-telit.html"}]}',
          ),
        }}
      />
