...
export default function SolutionEvcpPage() {
  return (
    <>
      <title>EVCP · AI EV Charging Operations Platform — OCUBE</title>
      <meta
        name="description"
        content="EVCP — a platform that connects charger, usage, payment and energy data, and uses AI to predict faults and demand so charging operations run better."
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: applyBase(
            '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"@@BASE@@en/"},{"@type":"ListItem","position":2,"name":"EVCP","item":"@@BASE@@en/solution-evcp.html"}]}',
          ),
        }}
      />
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>Operations and AI analysis on one screen</h2>
              <p className="lead">
                Site and charger status is read together with usage data, giving what you need to
                respond to faults and run the network better.
              </p>
            </div>
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Monitoring</span> <h3>Site monitoring</h3>
                <p>
                  See every site and charger on the map, and open the detail and usage history
                  straight away.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>By operator and region</b> Pick the site from a list by operator or region
                  </li>
                  <li>
                    <b>Status and history per charger</b> Charger status and recent usage in one
                    view
                  </li>
                  <li>
                    <b>Straight from the map</b> Choose the site on the map itself
                  </li>
                </ul>
              </div>
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                <span className="pill">Dashboard</span> <h3>Operations dashboard</h3>
                <p>
                  Arrange the charts you want, and watch charger status, revenue and energy
                  delivered as it happens.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Monthly revenue</b> Revenue trend by period
                  </li>
                  <li>
                    <b>Energy delivered</b> Monthly totals show the scale of the operation
                  </li>
                  <li>
                    <b>Chargers in service</b> By region — available, charging, offline and faulty
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <h3>Predicting faults, demand and energy</h3>
                <p>
                  Charging state, error history, usage patterns and energy consumption are read by
                  AI to suggest what the operator should look at first.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Early warning</b> Repeated errors and shifting status put the most likely
                    failures at the top of the list
                  </li>
                  <li>
                    <b>Demand forecast</b> Patterns by hour, day and area show expected demand and
                    where it will be busy
                  </li>
                  <li>
                    <b>Energy recommendations</b> Consumption and tariffs taken together to spread
                    load and adjust operating hours
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                <span className="pill">Event</span> <h3>Live event monitoring</h3>
                <p>
                  Charger events are collected live, shown in a list and on the map, and timed to
                  the moment the state changed.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Events as they happen</b> Start, idle, disconnect and the rest, recorded in
                    the order they occurred
                  </li>
                  <li>
                    <b>Where it happened</b> The site is shown on the map at the same time
                  </li>
                  <li>
                    <b>Change history</b> Charger ID, site name and the time of the change
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Search</span> <h3>Finding a site on the map</h3>
                <p>
                  Roaming partner sites and their chargers can be searched on the map. The driver
                  app and the admin app share the same map module.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Site and charger detail</b> Detail for each site and charger, from the map
                  </li>
                  <li>
                    <b>Search by address</b> Find a site by typing the address
                  </li>
                  <li>
                    <b>Filter by operator and type</b> Filter by operator and by charger type —
                    slow, fast and ultra-fast
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
        ...
        <section id="msa" className="sec-anchor deploy">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>Separate services, so a fault stays small and growth stays easy</h2>
              <p className="lead">
                Membership, charger integration (OCPP), payment and roaming each stand alone —
                limiting the blast radius of a fault and making it simple to add what you need.
              </p>
            </div>
            <div className="dep-grid reveal" data-d="1">
              <div className="dep-card">
                ...
                <h3>Membership</h3>
                <p>Sign-up, authentication, tariffs and usage history as their own service</p>
              </div>
              <div className="dep-card">
                <div className="ic" aria-hidden="true">
                  🔌
                </div>
                <h3>Charger integration (OCPP)</h3>
                <p>
              ...
              <div className="dep-card">
                ...
                <h3>Payment</h3>
                <p>Charging billed and settled per session, with payment gateway integration</p>
              </div>
              <div className="dep-card">
                <div className="ic" aria-hidden="true">
                  🔗
                ...
                <h3>Roaming</h3>
                <p>Roaming between operators widens where drivers can charge</p>
              </div>
            </div>
            <figure
        ...
        <section id="proof" className="sec-anchor">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2>Built for a client, kept as a product</h2>
            </div>
            ...
            <div className="case-grid two">
              <article className="case-card reveal" data-d="1">
                <span className="dom">Energy · SK Energy</span> <h3>EV charging platform</h3>
                <p className="csi">
                  <b>The problem</b> Entering the charging business with no platform for membership,
                  integration, payment or monitoring
                </p>
                <p className="csi">
                  <b>What we did</b> Built and ran microservices on OCPP — and kept the result as
                  EVCP, our own product
                </p>
                <p className="csi">
                  <b>The result</b> Everything a charging business needs, held as a platform we can
                  reuse
                </p>
              </article>
              <article className="case-card reveal" data-d="2">
                <span className="dom">Our own module</span> <h3>OCPP LTE module</h3>
                <p className="csi">
                  A Mini PCI LTE Cat M1 module developed in-house (2025) — we build the charging
                  communication hardware too
                </p>
              </article>
            </div>
