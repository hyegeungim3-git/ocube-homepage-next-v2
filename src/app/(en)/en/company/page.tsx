...
export default function CompanyPage() {
  return (
    <>
      <title>
        History — OCUBE CO., LTD.
      </title>
      <meta name="description" content="OCUBE’s history — the milestones from our founding in 2007, through embedded software to industrial AI." />
      ...
      <meta property="og:description" content="OCUBE’s history — the milestones from our founding in 2007, through embedded software to systems integration and industrial AI." />
      ...
      <meta name="twitter:description" content="OCUBE’s history — the milestones from our founding in 2007, through embedded software to systems integration and industrial AI." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"연혁\",\"item\":\"@@BASE@@en/company.html\"}]}") }} />
        ...
        <section id="history" className="sec">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              {" "}
              <h2 className="loc-h">
                From the founding to now
              </h2>
              <p className="lead">
                Starting in embedded software and widening into systems integration and industrial AI — set out as milestones.
              </p>
            </div>
            <div className="hist">
