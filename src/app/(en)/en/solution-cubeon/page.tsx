...
export default function SolutionCubeonPage() {
  return (
    <>
      <title>
        Cubeon · Industrial AI Operations Platform — OCUBE
      </title>
      <meta name="description" content="Cubeon — an industrial AI operations platform that standardises industrial data and carries AI judgement through to human approval and, within a proven scope, limited automatic execution." />
      <link rel="canonical" href={withBase("en/solution-cubeon.html")} />
      ...
      <meta property="og:title" content="Cubeon · Industrial AI Operations Platform — OCUBE" />
      <meta property="og:description" content="Cubeon — an industrial AI operations platform that standardises industrial data and carries AI judgement through to human approval and, within a proven scope, limited automatic execution." />
      <meta property="og:url" content={withBase("en/solution-cubeon.html")} />
      <meta property="og:image" content={withBase("og-codex.png")} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="Cubeon · Industrial AI Operations Platform — OCUBE" />
      <meta name="twitter:description" content="Cubeon — an industrial AI operations platform that standardises industrial data and carries AI judgement through to human approval and, within a proven scope, limited automatic execution." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Cubeon\",\"item\":\"@@BASE@@en/solution-cubeon.html\"}]}") }} />
      <SiteHeader slug="solution-cubeon" lang="en" />
      <MobilePanel lang="en" />
      <main>
            ...
            <div className="pin-right">
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    <b>
                      Edge collection and recovery
                    </b>
                    {" "}Data held locally when the network drops, sent again once it is back
                  </li>
                  <li>
                    <b>
                      Secure connections
                    </b>
                    {" "}Encryption, device authentication and role-based access protect data in transit
                  </li>
                </ul>
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}Latency and error rates measured at every stage, from collection to control, to find where it hurts
                  </li>
                  <li>
                    <b>
                      Scaling in steps
                    </b>
                    {" "}The same proven structure reused, from one line to the whole company
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}One format, quality checks and gap filling leave the data fit to analyse
                  </li>
                  <li>
                    <b>
                      Search by relationship
                    </b>
                    {" "}Follow the links between data, documents and work to find what you need
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}Shifts in input data and predictions signal when to retrain
                  </li>
                  <li>
                    <b>
                      Audit trail
                    </b>
                    {" "}Every judgement and action recorded, ready for quality and regulatory questions
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}Answers built on the documents and data found, with the sources kept
                  </li>
                  <li>
                    <b>
                      Permission aware
                    </b>
                    {" "}Role-based access decides which knowledge and functions each person can reach
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">
                  ...
                  <span className="pill light">
                    In-house small language model (sLLM)
                  </span>
                </div>
                {" "}
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    <b>
                      Bringing judgements together
                    </b>
                    {" "}What each agent concludes and recommends, merged into a single flow
                  </li>
                  <li>
                    <b>
                      Approval branching
                    </b>
                    {" "}Risk and reversibility decide which approval path an action takes
                  </li>
                </ul>
                <div className="pi-tags">
                  <span className="pill light">
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}Service health, response time, throughput, errors and work in progress, all in one view
                  </li>
                  <li>
                    <b>
                      Change and rollback
                    </b>
                    {" "}Changes to models, knowledge and settings are recorded, and an earlier version can be restored
                  </li>
                </ul>
                {" "}
              ...
              <article className="pin-item reveal">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    {" "}A commercial AI service, an in-house build, or a network cut off from the internet — whichever the rules require
                  </li>
                  <li>
                    <b>
                      A fixed data boundary
                    </b>
                    {" "}Policy fixes where restricted data is processed, so it never crosses the line
                  </li>
                </ul>
                {" "}
            ...
            <div className="cubeon-hero reveal">
              ...
              <div className="ladder" aria-label="Cubeon 운영 자동화 단계">
                <div className="rung">
                  ...
                  <span>
                    Collect data, read the state, detect anomalies, raise the alert
                  </span>
                </div>
                <div className="rung l2">
                  ...
                  <span>
                    Analyse the cause, recommend the action, have it checked and approved
                  </span>
                </div>
