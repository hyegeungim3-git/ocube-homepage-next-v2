...
export default function BusinessAxPage() {
  return (
    <>
      <title>
        AX · AI Transformation — OCUBE
      </title>
      <meta name="description" content="OCUBE AX — finding where AI can help in industrial data, automating reporting, and carrying AI judgement into action once a person approves it." />
      <link rel="canonical" href={withBase("en/business-ax.html")} />
      ...
      <meta property="og:title" content="AX · AI Transformation — OCUBE" />
      <meta property="og:description" content="OCUBE AX — finding where AI can help in industrial data, automating reporting, and carrying AI judgement into action once a person approves it." />
      <meta property="og:url" content={withBase("en/business-ax.html")} />
      <meta property="og:image" content={withBase("og-codex.png")} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="AX · AI Transformation — OCUBE" />
      <meta name="twitter:description" content="OCUBE AX — finding where AI can help in industrial data, automating reporting, and carrying AI judgement into action once a person approves it." />
      <meta name="twitter:image" content={withBase("og-codex.png")} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: applyBase("{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"홈\",\"item\":\"@@BASE@@en/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"비즈니스 · AX\",\"item\":\"@@BASE@@en/business-ax.html\"}]}") }} />
      <SiteHeader slug="business-ax" lang="en" />
      <MobilePanel lang="en" />
      <main id="top">
        {/* 1. HERO (풀스크린 · 이미지) */}
        <section className="hero page-hero business-hero dark">
          ...
          <div className="wrap business-hero-copy">
            ...
            <h1 className="business-hero-ko">
              {" "}
              <span>
                Better judgement, faster execution —
              </span>
              {" "}
              <span>
                changing how companies and industries run.
              </span>
              {" "}
            </h1>
          </div>
