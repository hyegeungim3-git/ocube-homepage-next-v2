...
export default function BusinessAxPage() {
  return (
    <>
      <title>AX · AI Transformation — OCUBE</title>
      <meta
        name="description"
        content="OCUBE AX — finding where AI can help in industrial data, automating reporting, and carrying AI judgement into action once a person approves it."
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: applyBase(
            '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"홈","item":"@@BASE@@en/"},{"@type":"ListItem","position":2,"name":"비즈니스 · AX","item":"@@BASE@@en/business-ax.html"}]}',
          ),
        }}
      />
