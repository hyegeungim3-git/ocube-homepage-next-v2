...
export default function SolutionDataqPage() {
  return (
    <>
      <title>QData · Industrial Data Platform — OCUBE</title>
      <meta
        name="description"
        content="QData — a platform that collects, standardises and unifies mixed industrial and OT data into something industrial AI can trust."
      />
      ...
      <main>
              ...
              <div className="wrap">
                <div className="ktsum reveal" data-d="4">
                  <div className="ktsum-card">
                    ...
                    <h2>Pipeline</h2>
                    <span className="sub">One flow, from collection to use</span>{" "}
                    <p>
                      From controllers and instruments to operating systems, via{" "}
                      <b>standard connectors</b>— and if the link drops, data is held at the edge.
                    </p>
                  </div>
                  <div className="ktsum-card">
                    {" "}
                    ...
                    <span className="sub">Documents, images, even speech</span>{" "}
                    <p>
                      Documents that mix tables and drawings are broken into units of meaning, and
                      text and speech recognition turn them{" "}
                      <b>into data you can search and train on.</b>
                    </p>
                  </div>
                  <div className="ktsum-card">
                    {" "}
                  ...
                  <div className="ktsum-card">
                    ...
                    <h2>Running data and models</h2>
                    <span className="sub">Quality and accuracy together</span>{" "}
                    <p>
                      <b>Data quality and change are watched</b>, and on drift the model is
        ...
        <section id="arch" className="sec-anchor deploy">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>How the data becomes usable by AI</h2>
              <p className="lead">
                Scattered sources are connected, refined through six steps, shaped for their
                purpose, and carried on into services.
              </p>
            </div>
            <div className="qarch rv" data-d="1">
              <div className="qa-stage">
                ...
                <span className="qa-sub">What your organisation already has</span>{" "}
                ...
                <div className="qa-item">
                  ...
                  <span>PDF · DOCX · PPT · email</span>
                </div>
                <div className="qa-item">
                  <b>Industrial data</b>
                  <span>PLC · sensors · time-series · video</span>
                </div>
                <div className="qa-item">
                  <b>Knowledge</b>
                  <span>Manuals · reports · standards · history</span>
                </div>
              </div>
              <div className="qa-stage core">
                ...
                <span className="qa-sub">Six steps that make industrial data usable by AI</span>{" "}
                <div className="qa-item qa-step">
                  <b>
                    <i>1</i>
                    Connect
                  </b>
                  <span>Many sources joined and collected</span>
                </div>
                <div className="qa-item qa-step">
                  <b>
                    <i>2</i>
                  ...
                  <span>Formats read and turned into structure</span>
                </div>
                <div className="qa-item qa-step">
                  <b>
                    <i>3</i>
                  ...
                  <span>Duplicates removed, errors corrected, gaps handled</span>
                </div>
                <div className="qa-item qa-step">
                  <b>
                    <i>4</i>
                  ...
                  <span>One schema, one set of units</span>
                </div>
                <div className="qa-item qa-step">
                  <b>
                    <i>5</i>
                  ...
                  <span>Domain and business context, and the relationships between things</span>
                </div>
                <div className="qa-item qa-step">
                  <b>
                    <i>6</i>
                  ...
                  <span>Data with quality, consistency and context</span>
                </div>
                <p className="qa-note">Data with quality, consistency and context → ready for AI</p>
              </div>
              <div className="qa-stage">
                <div className="qa-hd">
                ...
                <span className="qa-sub">One foundation, shaped differently for each purpose</span>{" "}
                <div className="qa-item">
                  <b>RAG Ready</b>
                  <span>For retrieval and grounding</span>
                </div>
                <div className="qa-item">
                  <b>CAG Ready</b>
                  <span>Context tuned for repeated reference</span>
                </div>
                <div className="qa-item">
                  <b>TAG Ready</b>
                  <span>Structured for exploring and aggregating</span>
                </div>
              </div>
              <div className="qa-stage">
                <div className="qa-hd">
                ...
                <span className="qa-sub">Outputs you can use as they are</span>{" "}
                <div className="qa-item">
                  <b>Knowledge Data</b>
                  <span>Chunks · embeddings · metadata · sources</span>
                </div>
                <div className="qa-item">
                  <b>Context Data</b>
                  <span>Domain context · policies · manuals · rules</span>
                </div>
                <div className="qa-item">
                  <b>Structured AI Data</b>
                  <span>Table datasets · semantic schema · features</span>
                </div>
                <div className="qa-item">
                  <b>Training Data</b>
                  <span>Instructions · Q&A · fine-tuning datasets</span>
                </div>
              </div>
              <div className="qa-stage">
                <div className="qa-hd">
                ...
                <div className="qa-item">
                  <b>LLM · sLLM</b>
                  <span>Commercial APIs and on-premises small models</span>
                </div>
                <div className="qa-item">
                  <b>AI agents</b>
                  <span>Answers with evidence, carried through to action</span>
                </div>
                <div className="qa-item">
                  <b>Predictive models</b>
                  <span>Anomaly detection, demand and quality forecasting</span>
                </div>
                <div className="qa-item">
                  <b>Cubeon</b>
                  <span>Judgement, turned into approval and action</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              <span className="kicker">Features</span> <h2>What turns data into an asset</h2>
              <p className="lead">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Pipeline</span> <h3>Following the work</h3>
                <p>
                  For each document, see how far it has got — from analysis through to appearing in
                  search.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Stage by stage</b> Analysis, splitting and embedding shown per document
                  </li>
                  <li>
                    <b>Change detection</b> New, updated and deleted items picked up automatically
                  </li>
                  <li>
                    <b>Personal data flagged</b> Documents holding sensitive information marked
                    separately
                  </li>
                </ul>
              </div>
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                <span className="pill">Chunking</span> <h3>Getting the search unit right</h3>
                <p>
                  How a document is split changes what search returns. The result is checked against
                  measures, and search quality improves.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Quality measures</b> Length, special characters, duplication and whether each
                    piece stands on its own
                  </li>
                  <li>
                    <b>Per-document check</b> Documents past the threshold marked as caution or
                    warning
                  </li>
                  <li>
                    <b>Splitting rules</b> Size, overlap and method, set once for everything
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Embedding</span> <h3>Checking vector quality</h3>
                <p>
                  Text becomes vectors the AI can find, and throughput, latency and index health are
                  watched from then on.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>By model</b> Dimensions, throughput and latency compared
                  </li>
                  <li>
                    <b>Index health</b> Collections, disk use and index type
                  </li>
                  <li>
                    <b>Re-ranking review</b> Candidates for better search quality, compared
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                <span className="pill">Recovery</span> <h3>Reprocessing what failed</h3>
                <p>
                  Documents stalled by encryption or size are found and run again, automatically or
                  by hand.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Where it stopped</b> Recorded — whether it failed at analysis, splitting or
                    embedding
                  </li>
                  <li>
                    <b>Automatic retry</b> A queue managed by retry count and priority
                  </li>
                  <li>
                    <b>Handing it to a person</b> What cannot recover on its own is passed to
                    someone
                  </li>
                </ul>
              </div>
            ...
            <div className="duo">
              <div className="duo-txt rv">
                <span className="pill">Governance</span> <h3>Access by permission</h3>
                <p>
                  A user’s permissions decide which documents the AI may draw on, and personal data
                  is masked.
                </p>
                <ul className="pi-bul">
                  <li>
                    <b>Folder-level permission</b> Open to all, to a department, or to a named few
                  </li>
                  <li>
                    <b>Masking personal data</b> Documents holding sensitive fields are flagged and
                    covered
                  </li>
                  <li>
                    <b>What has landed</b> Chunk count and processing state per document
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
        ...
        <section id="standards" className="sec-anchor">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2>Built on the standards the industry already uses</h2>
              <p className="sec-sub">
                Designed with reference to industrial interoperability standards and established
            ...
            >
              ...
              <span className="pill light">Data catalogue</span>{" "}
              <span className="pill light">Change history</span>{" "}
            </div>
