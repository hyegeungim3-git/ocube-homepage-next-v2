...
export default function ReferencesPage() {
  return (
    <>
      <title>Build Cases — OCUBE CO., LTD.</title>
      <meta
        name="description"
        content="OCUBE build cases — manufacturing, energy, mobility, public sector, finance, home AIoT and enterprise services. References by industry, and our AX, embedded and SI work, set out as problem, approach and result."
      />
      ...
      <meta
        ...
        content="Manufacturing, energy, mobility, public sector, finance, home AIoT and enterprise services — build cases by industry, as problem, approach and result."
      />
      ...
      <meta
        ...
        content="Manufacturing, energy, mobility, public sector, finance, home AIoT and enterprise services — build cases by industry."
      />
