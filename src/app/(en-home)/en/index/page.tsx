    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: applyBase(
            '{"@context":"https://schema.org","@type":"Organization","name":"오큐브 주식회사","alternateName":"OCUBE Co., Ltd.","url":"@@BASE@@en/","logo":"@@BASE@@en/assets/og-image.jpg","foundingDate":"2007-03-29","description":"임베디드·SI 기반의 산업 AI 솔루션 기업","address":{"@type":"PostalAddress","streetAddress":"수성구 알파시티1로31길 18","addressLocality":"대구광역시","addressCountry":"KR"},"telephone":"+82-53-313-5333","email":"sales@ocube.co.kr"}',
          ),
        }}
      />
      <script
      ...
      <main>
        ...
        <section id="ci" className="typo-section">
          <div className="typo-layout">
            ...
            <div className="typo-copy">
              <p>
                OCUBE was born where <b>OPEN</b>
                (open collaboration) meets <b>CUBE</b>
                (solid engineering). <br />
                We start from the customer’s problem and build products and systems that hold up in
                daily operation — through AX, embedded software and systems integration.
              </p>{" "}
              <a href="#business">
                Read more{" "}
        ...
        <section id="business" className="capabilities-section">
          <div className="capabilities-head">
            ...
            <h2>Three capabilities that move change forward</h2>
            <p>
              We turn data into decisions you can act on,
              <br className="sb" /> We turn technology into services and products that actually run,
              <br className="sb" /> bringing your business closer to what comes next.
            </p>
          </div>
          <div className="capabilities-grid">
            <article className="capability-card is-active" aria-current="true">
              <div className="capability-title-row">
                <div className="capability-title">
                  <img
                    src="../assets/home-refresh/capability-ax.svg"
                    alt=""
                    width="32"
                    height="32"
                  />
              ...
              <p>
                connecting better judgement with faster execution, and changing how companies and
                industries operate.
              </p>
            ...
            <article className="capability-card">
              ...
              <p>
                From mobility to industrial devices, our software delivers smart connectivity and
            ...
            <article className="capability-card">
              <div className="capability-title-row">
                <div className="capability-title">
                  <img
                    src="../assets/home-refresh/capability-si.svg"
                    alt=""
                    width="32"
                    height="32"
                  />
              ...
              <p>
                We turn business requirements into stable, connected systems that make day-to-day
                work more efficient.
              </p>
              <div className="capability-chips">
                <span>BUSINESS</span>
        ...
        <section id="partners" className="global-tech-section" aria-labelledby="home-partner-title">
          <div className="global-tech-copy">
            ...
            <p>
              From choosing the right product and supplying genuine licences to porting,
              integration, customisation and hands-on engineering support — OCUBE engineers stay
              with you throughout.
            </p>
          </div>
        ...
        <section id="references" className="bcase home-cases-section">
          <div className="home-cases-sticky">
            <div className="home-case-opening">
              <h2>Projects that met real industry needs and proved themselves in operation</h2>
            </div>
            <div className="home-cases-panel">
              <div id="case-content" className="bcase-head">
                {" "}
                <span className="eb">BUILD CASES</span> <h2>Build cases</h2>
                <p>
                  OCUBE projects built on a precise reading of each industry’s needs, and delivered
                  as software and systems that run reliably in the real operating environment.
                </p>
              </div>
          ...
          <div className="contact-shell">
            <div className="contact-top">
              <div className="contact-copy">
                ...
                <h2>Tell us the problem you are trying to solve</h2>
                <p className="contact-description">
                  An engineer reads every enquiry personally and gets back to you — whether you need
                  a first consultation, a technical answer or a licence quote.
                </p>{" "}
            ...
            <div className="contact-info">
              <div className="contact-company">
                ...
                <dl>
                  <div>
                    <dt>DAEGU</dt>
                    <dd>18, Alpha City 1-ro 31-gil, Suseong-gu, Daegu, Korea (Head office)</dd>
                  </div>
                  <div>
                    <dt>SEOUL</dt>
                  ...
                  <div>
                    <dt>ANYANG</dt>
                    <dd>
                      #710, #722–723, Geumjeong Station SKV1 Center, 142 LS-ro, Dongan-gu, Anyang,
                      Korea
                    </dd>
                  </div>
                </dl>
