...
export function SolutionFactoryqPage({ lang }: { lang: Lang }): JSX.Element {
  return (
    <>
      <PageMeta
        lang={lang}
        path="solution-factoryq.html"
        title={t(lang, "QFactory AI 스마트 팩토리 — 오큐브")}
        description={t(
          lang,
          "QFactory — 공정·설비·품질·에너지·안전 데이터를 연결하고, 예측·최적화부터 승인 기반 운영까지 지원하는 AI 스마트 팩토리 플랫폼.",
        )}
      />
      <script
      ...
      <PageShell
        ...
        cta={
          <>
            <FctaTop copy={ctaCopy[lang]["solution-factoryq"]} />
          </>
        }
      >
        <div className="sol-open">
          ...
          <section className="sol-intro">
            <SolCopy intro={solutionIntros[lang]["solution-factoryq"]} />
            <div className="sol-body">
              <figure className="sol-stage rv d3">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-hibox-ai-operations.png", lang)}
                  alt={t(
                    lang,
        ...
        <Subnav items={subnavItems[lang]["solution-factoryq"]} />
        <section id="overview" className="sec-anchor">
          <div className="wrap">
            <SecHead copy={secHeads[lang]["solution-factoryq:overview"]} />
            <div className="media-duo overview-balanced reveal" data-d="1">
              <figure>
                <img
                  className="shot"
                  src={assetPath("assets/img/overview-qfactory.png", lang)}
                  alt={t(
                    lang,
              ...
              <div className="feat-list">
                {" "}
                <FeatItems items={featLists[lang]["solution-factoryq:overview"]} />
              </div>
            </div>
          </div>
        </section>
        <section id="applications" className="sec-anchor factory-apps">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>
                <T l={lang}>공장 운영 전 과정을 여섯 가지 AI 기능으로 연결합니다</T>
              </h2>
              <p className="lead">
                <T l={lang}>
            ...
            <p className="factory-note rv d1">
              ...
              <T l={lang}>
                기존 설비를 전면 교체하지 않고, 기존 설비 보완용 센서와 엣지 시스템 연계를 활용해
                필요한 공정부터 확장합니다.
              </T>
            </p>
              ...
              <article className="factory-app rv">
                ...
                <dl>
                  ...
                  <div>
                    ...
                    <dd>
                      <T l={lang}>정합성 검증, 원인 추적, AI 학습용 표준 데이터</T>
                    </dd>
                  </div>
                </dl>
              </article>
              <article className="factory-app rv d1">
                ...
                <dl>
                  ...
                  <div>
                    ...
                    <dd>
                      <T l={lang}>소각로·보일러·Dryer 생산–사용 밸런싱</T>
                    </dd>
                  </div>
                </dl>
              </article>
              <article className="factory-app rv d2">
                ...
                <dl>
                  <div>
                    ...
                    <dd>
                      <T l={lang}>진동·전류·온도·압력·유량·정비 이력</T>
                    </dd>
                  </div>
                  <div>
                    <dt>
                    ...
                    <dd>
                      <T l={lang}>고장 조기경보, 정비 우선순위, 다운타임 예방</T>
                    </dd>
                  </div>
                </dl>
              </article>
              <article className="factory-app rv">
                ...
                <dl>
                  <div>
                    ...
                    <dd>
                      <T l={lang}>농도·입도·공정조건·검사·출하 Lot</T>
                    </dd>
                  </div>
                  <div>
                    <dt>
                    ...
                    <dd>
                      <T l={lang}>품질 예측, 원인 추적, 공급망 피드백</T>
                    </dd>
                  </div>
                </dl>
              </article>
              <article className="factory-app rv d1">
                ...
                <dl>
                  <div>
                    ...
                    <dd>
                      <T l={lang}>실시간 영상 스트림(RTSP)·작업 구역·설비 알람</T>
                    </dd>
                  </div>
                  <div>
                    <dt>
                    ...
                    <dd>
                      <T l={lang}>위험도별 알림, 이력 조회, 오탐 피드백</T>
                    </dd>
                  </div>
                </dl>
              </article>
              <article className="factory-app rv d2">
                ...
                <dl>
                  <div>
                    ...
                    <dd>
                      <T l={lang}>모델·데이터 버전·성능·데이터 변화</T>
                    </dd>
                  </div>
                  <div>
                    <dt>
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>
                <T l={lang}>공정 진단부터 AI 모델 운영까지 연결합니다</T>
              </h2>
              <p className="lead">
                <T l={lang}>
                  설비·
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    <T l={lang}>담당자 검토로 오탐과 실제 이상 구분</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>안전한 단계 전환</T>
                    </b>{" "}
                    <T l={lang}>승인된 진단 결과만 공정 설계와 실시간 관제로 연결</T>
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-feature-equipment-diagnostics.png", lang)}
                  alt={t(
                    lang,
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                <span className="pill">Recommend</span>{" "}
                <h3>
                  <T l={lang}>AI 공정 설계 권고</T>
                </h3>
                <p>
                  <T l={lang}>
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-feature-process-design.jpg", lang)}
                  alt={t(
                    lang,
              ...
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    <T l={lang}>정상 패턴과 다른 변화의 위험도와 원인 후보 기록</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>운영자 안전 조치</T>
                    </b>{" "}
                    <T l={lang}>경고 확인 후 공정 중단과 대응 이력 관리</T>
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-feature-live-monitoring.png", lang)}
                  alt={t(
                    lang,
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>
                      <T l={lang}>3차원 공정 재현</T>
                    </b>{" "}
                    <T l={lang}>설비와 제품 상태를 3차원 화면으로 재생</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>이상 원인 추적</T>
                    </b>{" "}
                    <T l={lang}>감지 점수와 센서 변화를 비교해 원인 후보 확인</T>
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-feature-cycle-analysis.png", lang)}
                  alt={t(
                    lang,
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    <T l={lang}>취약 지표를 찾아 개선 우선순위 제시</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>사이클 추이 비교</T>
                    </b>{" "}
                    <T l={lang}>
                      기간·
                      <wbr />
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-feature-kpi-analysis.png", lang)}
                  alt={t(
                    lang,
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>
                      <T l={lang}>검증 후 운영 적용</T>
                    </b>{" "}
                    <T l={lang}>기존 버전과 비교해 승인된 모델만 반영</T>
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/qfactory-feature-mlops.png", lang)}
                  alt={t(
                    lang,
        ...
        <section id="why" className="sec-anchor">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2>
                <T l={lang}>AI로 이상 징후를 더 일찍 찾고 대응 방향까지 제시합니다</T>
              </h2>
              <p className="sec-sub">
                <T l={lang}>
                  기존 임계값 알람만으로 놓치기 쉬운 미세한 변화와 원인, 정비 시점을 AI로
                  보완합니다.
                </T>
              </p>
            </div>
            <table className="cmp reveal" data-d="1">
              ...
              <caption className="sr-only">
                <T l={lang}>규칙 기반 임계 감시와 QFactory 제조 AI 비교표</T>
              </caption>{" "}
              <thead>
                <tr>
                  <th scope="col">
                  ...
                  <th scope="col">
                    <T l={lang}>규칙 기반 임계 감시</T>
                  </th>
                  <th scope="col" className="ok">
                    <T l={lang}>QFactory 제조 AI</T>
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td>
                    <T l={lang}>고정 임계 초과 시 알람(사후)</T>
                  </td>
                  <td className="ok">
                    <T l={lang}>정상 패턴 학습 후 미세 이탈 조기 감지</T>
                  </td>
                </tr>
                <tr>
                  <th scope="row">
        ...
        <section id="fit" className="sec-anchor deploy">
          <div className="wrap">
            <SecHead copy={secHeads[lang]["solution-factoryq:fit"]} />
            <div className="dep-grid g2 reveal" data-d="1" style={{ marginTop: "24px" }}>
              {" "}
              <DepCards items={depCards[lang]["solution-factoryq:fit"]} />
            </div>
          </div>
        </section>
      </PageShell>
