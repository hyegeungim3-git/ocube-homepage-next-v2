  ...
  return (
    <>
      ...
      >
        ...
        {/* 2. 파트너 가로 슬라이드 */}
        <section className="pcl" aria-label={t(lang, "AI 전환 파트너 및 고객사")}>
          ...
          <div className="pcl-mq">
            <div className="pcl-track">
              <div className="pcl-logo">
                <img
                  src={assetPath("assets/img/client/lg-electronics.png", lang)}
                  alt={t(lang, "LG전자")}
                  loading="lazy"
                  width="280"
                  height="90"
              ...
              <div className="pcl-logo">
                <img
                  src={assetPath("assets/img/client/sk-energy.png", lang)}
                  alt={t(lang, "SK에너지")}
                  loading="lazy"
                  width="280"
                  height="90"
              ...
              <div className="pcl-logo">
                <img
                  src={assetPath("assets/img/client/ls-electric.png", lang)}
                  alt="LS ELECTRIC"
                  loading="lazy"
                  width="170"
                  height="45"
              ...
              <div className="pcl-logo">
                <img
                  src={assetPath("assets/img/client/doosan.png", lang)}
                  alt={t(lang, "두산")}
                  loading="lazy"
                  width="280"
                  height="90"
              ...
              <div className="pcl-logo">
                <img
                  src={assetPath("assets/img/client/dgb-financial-group.png", lang)}
                  alt={t(lang, "DGB금융지주")}
                  loading="lazy"
                  width="280"
                  height="90"
