...
export function SolutionEvcpPage({ lang }: { lang: Lang }): JSX.Element {
  return (
    <>
      <PageMeta
        lang={lang}
        path="solution-evcp.html"
        title={t(lang, "EVCP AI 전기차 충전 운영 플랫폼 — 오큐브")}
        description={t(
          lang,
          "EVCP — 충전기·이용·결제·에너지 데이터를 연결하고 AI로 장애와 수요를 예측해 전기차 충전 운영을 최적화하는 플랫폼.",
        )}
      />
      <script
      ...
      <PageShell
        ...
        cta={
          <>
            <FctaTop copy={ctaCopy[lang]["solution-evcp"]} />
          </>
        }
      >
        <div className="sol-open">
          ...
          <section className="sol-intro">
            <SolCopy intro={solutionIntros[lang]["solution-evcp"]} />
            <div className="sol-body">
              <figure className="sol-stage rv d3">
                {" "}
                <img
                  src={assetPath("assets/img/evcp.png", lang)}
                  alt={t(lang, "EVCP 화면 — 프로토타입 예시")}
                  loading="lazy"
                  width="1746"
                  height="748"
                />{" "}
        ...
        <Subnav items={subnavItems[lang]["solution-evcp"]} />
        <section id="overview" className="sec-anchor">
          <div className="wrap">
            <SecHead copy={secHeads[lang]["solution-evcp:overview"]} />
            <div className="media-duo overview-balanced reveal" data-d="1">
              <figure>
                <img
                  className="shot"
                  src={assetPath("assets/img/overview-evcp.png", lang)}
                  alt={t(
                    lang,
                    "EVCP가 전기차 충전기의 실시간 관제와 사용자·결제·정산·분석·안전 관리를 연결하는 모습",
                  )}
                  loading="lazy"
                  width="1565"
                  height="1005"
              ...
              <div className="feat-list">
                {" "}
                <FeatItems items={featLists[lang]["solution-evcp:overview"]} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="sec-anchor">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>
                <T l={lang}>충전 운영과 AI 분석을 한 화면에서 확인합니다</T>
              </h2>
              <p className="lead">
                <T l={lang}>
                  충전소·
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    ...
                    <T l={lang}>충전기 상태와 최근 이용 이력을 한 화면에서 확인</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>지도에서 직접 선택</T>
                    </b>{" "}
                    <T l={lang}>원하는 충전소를 지도에서 바로 선택</T>
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
                ...
                <img
                  src={assetPath("assets/img/evcp.png", lang)}
                  alt={t(lang, "EVCP 충전소 관제 화면 — 지도 기반 운영 충전소·충전기 상태")}
                  loading="lazy"
                  width="1746"
                  height="748"
                />{" "}
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  <li>
                    ...
                    <T l={lang}>기간별 매출 추이 차트</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>충전량 통계</T>
                    </b>{" "}
                    <T l={lang}>월별 충전량 집계로 운영 규모 파악</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>가동 충전기 수</T>
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/evcp-dash.jpg", lang)}
                  alt={t(lang, "EVCP 다이나믹 대시보드 — 월별 매출·충전량·가동 충전기 수 차트")}
                  loading="lazy"
                  width="1400"
                  height="298"
                />{" "}
            ...
            <div className="duo">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>
                      <T l={lang}>에너지 운영 권고</T>
                    </b>{" "}
                    <T l={lang}>전력 사용량과 요금 조건을 고려해 부하 분산과 운영 시간 조정 지원</T>
                  </li>
                </ul>
              </div>
              <div className="duo-media stage rv d1">
                ...
                <img
                  ...
                  alt={t(
                    lang,
                    "충전기 상태와 이용 통계를 분석해 이상 징후·수요·에너지 운영을 지원하는 EVCP 구성",
                  )}
                  loading="lazy"
                  width="1565"
                  height="1005"
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <ul className="pi-bul">
                  ...
                  <li>
                    <b>
                      <T l={lang}>지도 기반 위치 확인</T>
                    </b>{" "}
                    <T l={lang}>이벤트가 발생한 충전소 위치를 지도에 동시 표시</T>
                  </li>
                  <li>
                    <b>
                      <T l={lang}>상태 변경 이력 추적</T>
                    </b>{" "}
                    <T l={lang}>
                      충전기 아이디·
                      <wbr />
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/evcp-event.jpg", lang)}
                  alt={t(lang, "EVCP 실시간 이벤트 관제 — 충전기 상태 이벤트 목록과 지도 표시")}
                  loading="lazy"
                  width="1400"
                  height="446"
                />{" "}
            ...
            <div className="duo">
              ...
              <div className="duo-media stage rv d1">
                {" "}
                <img
                  src={assetPath("assets/img/evcp-search.jpg", lang)}
                  alt={t(lang, "EVCP 지도 기반 충전소 검색 — 충전소·충전기 상세 정보와 주소 검색")}
                  loading="lazy"
                  width="1200"
                  height="348"
                />{" "}
        ...
        <section id="msa" className="sec-anchor deploy">
          <div className="wrap">
            <div className="sec-head rv">
              ...
              <h2>
                <T l={lang}>기능별 서비스를 분리해 장애 영향은 줄이고 확장은 쉽게 합니다</T>
              </h2>
              <p className="lead">
                <T l={lang}>
            ...
            <div className="dep-grid reveal" data-d="1">
              ...
              <div className="dep-card">
                ...
                <p>
                  <T l={lang}>사업자 간 로밍으로 이용 가능한 충전소 범위 확대</T>
                </p>
              </div>
            </div>
            <figure
            ...
            >
              ...
              <img
                className="shot fit"
                src={assetPath("assets/img/evcp-msa.jpg", lang)}
                alt={t(
                  lang,
                  "EVCP 서비스 구조도 — 클라이언트(WEB·WAS)와 퍼블릭 클라우드의 회원·충전기연동(OCPP)·App·결제·로밍 서비스",
                )}
                loading="lazy"
                width="1000"
                height="862"
        ...
        <section id="proof" className="sec-anchor">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2>
                <T l={lang}>구축 경험을 제품 자산으로 전환했습니다</T>
              </h2>
            </div>
            <div className="hero-stats reveal">
              <StatItems items={evcpStats[lang]} />
            </div>
            <div className="case-grid two">
              <article className="case-card reveal" data-d="1">
                <span className="dom">
                  <T l={lang}>에너지 · SK에너지</T>
                </span>{" "}
                <h3>
                  <T l={lang}>EV 충전 플랫폼 구축</T>
                </h3>
                <p className="csi">
                  <b>
                    <T l={lang}>과제</T>
                ...
                <p className="csi">
                  ...
                  <T l={lang}>충전 사업에 필요한 기능 전체를 재사용 가능한 자체 플랫폼으로 확보</T>
                </p>
              </article>
        ...
        <section id="fit" className="sec-anchor deploy">
          <div className="wrap">
            <SecHead copy={secHeads[lang]["solution-evcp:fit"]} />
            <div className="dep-grid g2 reveal" data-d="1" style={{ marginTop: "24px" }}>
              {" "}
              <DepCards items={depCards[lang]["solution-evcp:fit"]} />
            </div>
          </div>
        </section>
      </PageShell>
