...
export function LicenseVisualonPage({ lang }: { lang: Lang }): JSX.Element {
  return (
    <>
      <PageMeta
        lang={lang}
        path="license-visualon.html"
        title={t(lang, "VisualOn — 멀티미디어 재생 개발도구(SDK) | Global Partners · 오큐브(주)")}
        description={t(
          lang,
          "OnStream MediaPlayer+ 등 VisualOn 멀티미디어 제품군 — 오큐브가 공급과 국내 엔지니어링 지원을 제공합니다.",
        )}
      ...
      <PageShell
        ...
        cta={
          <>
            <FctaTop copy={ctaCopy[lang]["license-visualon"]} />
          </>
        }
      >
        {" "}
        <PageHero lang={lang} data={heroes[lang]["license-visualon"]} />{" "}
        <section id="onstream" className="sec">
          <div className="wrap">
            <SecHead copy={secHeads[lang]["license-visualon:onstream"]} />
            <div className="duo">
              <div className="duo-txt rv">
                {" "}
                <span className="pill">OnStream MediaPlayer+</span>{" "}
                <h3>
                  <T l={lang}>다양한 OTT 기능을 제공하는 프리미엄 플레이어 개발도구(SDK)</T>
                </h3>
                <p>
                  <T l={lang}>
              ...
              <div className="duo-media plain rv d1">
                <img
                  src={assetPath("assets/img/vendor/visualon.png", lang)}
                  alt={t(lang, "OnStream MediaPlayer+ 멀티 디바이스 재생")}
                  loading="lazy"
                  width="476"
                  height="300"
                />
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <h3>
                  <T l={lang}>기본 플레이어 API와 호환되는 스트리밍 솔루션</T>
                </h3>
                <p>
                  <T l={lang}>Android ExoPlayer, iOS AVPlayer 등 기본 플레이어 API와 연동됩니다.</T>
                  <br className="sb" />{" "}
                  <T l={lang}>
                    분석·
                    <wbr />
              ...
              <div className="duo-media plain rv d1">
                <img
                  src={assetPath("assets/img/vendor/visualon_exoplay.png", lang)}
                  alt={t(lang, "ExoPlayer+ / AVPlayer+ 구성")}
                  loading="lazy"
                  width="760"
                  height="493"
                />
            ...
            <div className="duo">
              <div className="duo-txt rv">
                {" "}
                <span className="pill">
                  <T l={lang}>HTML5 Player+ · 사용자 경험(UX) 모니터</T>
                </span>{" "}
                <h3>
                  <T l={lang}>브라우저 재생 품질과 사용자 경험 모니터링</T>
                </h3>
                <p>
                  <T l={lang}>HTML5 환경에서 안정적인</T>{" "}
                  <b>
                    <T l={lang}>브라우저 내 재생 경험</T>
                  </b>
                  <T l={lang}>을 제공합니다.</T>
                  <br className="sb" />{" "}
                  <T l={lang}>
              ...
              <div className="duo-media plain rv d1">
                <img
                  src={assetPath("assets/img/vendor/visualon_vis01.png", lang)}
                  alt={t(lang, "VisualOn 재생 분석 대시보드")}
                  loading="lazy"
                  width="510"
                  height="282"
                />
            ...
            <div className="duo rev">
              <div className="duo-txt rv">
                ...
                <h3>
                  <T l={lang}>모빌리티에 최적화된 소프트웨어 코덱/파서</T>
                </h3>
                <p>
                  <T l={lang}>
              ...
              <div className="duo-media plain rv d1">
                <img
                  src={assetPath("assets/img/vendor/visualon-ivi.jpg", lang)}
                  alt={t(
                    lang,
                    "차량 클러스터와 인포테인먼트(IVI) 화면에서 동작하는 VisualOn 재생 소프트웨어",
                  )}
                  loading="lazy"
                  width="670"
                  height="477"
        ...
        <section id="apply" className="sec-anchor deploy">
          <div className="wrap">
            <SecHead copy={secHeads[lang]["license-visualon:apply"]} />
            <div className="dep-grid reveal" data-d="1" style={{ marginTop: "22px" }}>
              {" "}
              <DepCards items={depCards[lang]["license-visualon:apply"]} />
            </div>
          </div>
        </section>
      </PageShell>
