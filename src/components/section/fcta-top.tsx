  ...
  return (
    <div className="fcta-top">
      ...
      <div className="cta-badge">
        {" "}
        <svg className="cta-badge-ring" viewBox="0 0 200 200" width="180" height="180" aria-hidden="true">
          {" "}
          <defs>
            <path id="ctaBadgePath" d="M100,100 m-84,0 a84,84 0 1,1 168,0 a84,84 0 1,1 -168,0"></path>
          </defs>
          {" "}
        ...
        <a href="contact.html" className="cta-badge-core" aria-label={copy.badgeLabel}>
          ...
          <svg viewBox="0 0 19 17" width="19" height="17" aria-hidden="true">
            <path d="M10.7 1 17.7 8.3 10.7 15.6M17.7 8.3H1" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
          </svg>
          {" "}
        </a>
        {" "}
