...
- 2026-08-13 결정 — **좁은 화면(≤1150px)에서 헤더 메뉴가 KR/EN 을 침범하는 것은 지금대로 둔다.**
  두 판 공통의 기존 상태이고, 해결하려면 기준폭을 올리거나 CTA 를 감춰야 해 설계 변경이다.
  자세한 수치와 선택지는 `docs/pitfalls.md` 2절. **버그로 보고 임의로 고치지 말 것.**
